---
title: "Calculadora de Peso | Calculadora de Gravedad y Peso Planetario (W = mg)"
description: "Calculadora de peso en línea gratuita. Resuelve al instante W = mg, compara tu peso en 10 planetas del Sistema Solar (Tierra, Luna, Marte, Júpiter), visualiza la masa vs peso, y convierte unidades."
metaTitle: "Calculadora de Peso | Calculadora de Gravedad y Peso Planetario (W = mg)"
metaDescription: "Calculadora de peso en línea gratuita. Resuelve al instante W = mg, compara tu peso en 10 planetas del Sistema Solar (Tierra, Luna, Marte, Júpiter), visualiza la masa vs peso, y convierte unidades."
metaKeywords: "calculadora de peso, calculadora de peso gravitacional, calculadora de fórmula de peso, calculadora de peso en otros planetas, calculadora de masa vs peso, calculadora de física para resolver peso"
features:
  - "Cabina de Peso Interactiva con alternancia entre Modo Simple y Avanzado"
  - "3 Modos de Cálculo: Peso (W = mg), Masa (m = W/g), Gravedad Superficial (g = W/m)"
  - "🧑‍🚀 Modo Astronauta y Explorador de Peso en 10 Planetas del Sistema Solar (Tierra, Luna, Marte, Mercurio, Venus, Júpiter, Saturno, Urano, Neptuno, Plutón)"
  - "⚖️ Visualizador de Masa vs Peso que ilustra la masa invariable frente a la fuerza de peso gravitacional variable"
  - "🎯 Preajustes de Objetos del Mundo Real (Humano, Mochila, Coche, Camión, Satélite, Cohete Starship, Contenedor, Elefante)"
  - "📊 Gráfico de Barras Interactivo de Comparación de Peso Planetario usando Recharts"
  - "Medidor de Peso Radial Logarítmico que categoriza los niveles de fuerza de peso"
  - "Generador de Cuestionarios de Práctica de Física con problemas de peso aleatorios y derivaciones matemáticas paso a paso"
useCases:
  - "Estudiantes y profesores de física aclarando la distinción entre masa (kg) y fuerza de peso (N)"
  - "Ingenieros aeroespaciales y planificadores de misiones calculando el peso de las naves espaciales en los sitios de aterrizaje planetario"
  - "Ingenieros civiles y estructurales convirtiendo cargas de masa en entradas de fuerza gravitacional para el diseño de edificios"
  - "Entusiastas de la astronomía explorando cuánto pesarían en la Luna, Marte o el gigante Júpiter"
howToSteps:
  - "Selecciona tu modo de cálculo objetivo: Peso (W), Masa (m) o Gravedad Superficial (g)."
  - "Ingresa tus valores conocidos en los campos de entrada o ajusta los controles deslizantes de rango interactivos."
  - "Elige tu sistema de unidades preferido (por ejemplo, Newtons, kilonewtons, libras-fuerza, kgf, kilogramos, libras, m/s², ft/s²)."
  - "Elige un preajuste de planeta de las 10 opciones del Sistema Solar (Tierra, Luna, Marte, Júpiter, Venus, etc.)."
  - "Alterna el Modo Avanzado para ver el Modo Astronauta, la Tabla del Explorador de Peso de Planetas y los Gráficos de Masa vs Peso."
  - "Exporta tu resumen de cálculo a través de la impresión en PDF, copia el texto formateado o comparte un enlace de parámetro personalizado."
faqs:
  - question: "¿Qué es el peso en física?"
    answer: "El peso es la fuerza ejercida sobre una masa por un campo gravitacional, definida matemáticamente como W = m · g."
  - question: "¿Cuál es la unidad del SI para el peso?"
    answer: "La unidad del SI para el peso es el Newton (N), porque el peso es una fuerza. 1 Newton = 1 kg·m/s²."
  - question: "¿Cuál es la diferencia entre masa y peso?"
    answer: "La masa es una propiedad intrínseca que mide la cantidad de materia en un objeto (medida en kg) y permanece constante en todas partes. El peso es una fuerza hacia abajo (medida en N) que cambia dependiendo del campo gravitacional local (g)."
  - question: "¿Cuál es la fórmula para el peso?"
    answer: "La fórmula fundamental para el peso es W = m · g, donde m es la masa en kilogramos y g es la aceleración debida a la gravedad en m/s²."
  - question: "¿Cuál es la aceleración debida a la gravedad en la Tierra?"
    answer: "La aceleración estándar debida a la gravedad en la superficie de la Tierra es g = 9.80665 m/s² (comúnmente redondeada a 9.81 m/s² o 32.2 ft/s²)."
  - question: "¿Cuánto pesa una persona de 70 kg en la Tierra?"
    answer: "En la Tierra (g = 9.81 m/s²), una persona de 70 kg tiene un peso de W = 70 · 9.81 = 686.7 Newtons (154.4 lbf)."
  - question: "¿Cuánto pesa una persona de 70 kg en la Luna?"
    answer: "La gravedad de la Luna es g = 1.62 m/s² (aproximadamente 1/6 de la gravedad de la Tierra). Una persona de 70 kg pesa W = 70 · 1.62 = 113.4 Newtons en la Luna."
  - question: "¿Cuánto pesa una persona de 70 kg en Marte?"
    answer: "La gravedad de Marte es g = 3.71 m/s² (aproximadamente el 38% de la gravedad de la Tierra). Una persona de 70 kg pesa W = 70 · 3.71 = 259.7 Newtons en Marte."
  - question: "¿Cuánto pesa una persona de 70 kg en Júpiter?"
    answer: "La gravedad de la superficie de Júpiter es g = 24.79 m/s² (aproximadamente 2.53 veces la gravedad de la Tierra). ¡Una persona de 70 kg pesa W = 70 · 24.79 = 1,735.3 Newtons en Júpiter!"
  - question: "¿Cuánto pesa una persona de 70 kg en Venus?"
    answer: "La gravedad de Venus es g = 8.87 m/s² (aproximadamente el 90% de la gravedad de la Tierra). Una persona de 70 kg pesa W = 70 · 8.87 = 620.9 Newtons en Venus."
  - question: "¿Cuánto pesa una persona de 70 kg en Mercurio?"
    answer: "La gravedad de Mercurio es g = 3.70 m/s². Una persona de 70 kg pesa W = 70 · 3.70 = 259.0 Newtons en Mercurio."
  - question: "¿Cuánto pesa una persona de 70 kg en Saturno?"
    answer: "La gravedad de la superficie de Saturno es g = 10.44 m/s². Una persona de 70 kg pesa W = 70 · 10.44 = 730.8 Newtons en Saturno."
  - question: "¿Cuánto pesa una persona de 70 kg en Urano?"
    answer: "La gravedad de Urano es g = 8.69 m/s². Una persona de 70 kg pesa W = 70 · 8.69 = 608.3 Newtons en Urano."
  - question: "¿Cuánto pesa una persona de 70 kg en Neptuno?"
    answer: "La gravedad de Neptuno es g = 11.15 m/s². Una persona de 70 kg pesa W = 70 · 11.15 = 780.5 Newtons en Neptuno."
  - question: "¿Cuánto pesa una persona de 70 kg en Plutón?"
    answer: "La gravedad de Plutón es g = 0.62 m/s² (aproximadamente 1/16 de la gravedad de la Tierra). ¡Una persona de 70 kg pesa W = 70 · 0.62 = 43.4 Newtons en Plutón!"
  - question: "¿Cómo se calcula la masa a partir del peso y la gravedad?"
    answer: "La masa se calcula utilizando la fórmula m = W / g."
  - question: "¿Cómo se calcula la gravedad a partir del peso y la masa?"
    answer: "La gravedad superficial se calcula utilizando la fórmula g = W / m."
  - question: "¿Cómo se convierten Newtons (N) a libras-fuerza (lbf)?"
    answer: "Divide los Newtons entre 4.44822 (o multiplica por 0.224809) para obtener libras-fuerza (lbf)."
  - question: "¿Cómo se convierten libras-fuerza (lbf) a Newtons (N)?"
    answer: "Multiplica las libras-fuerza por 4.44822 para obtener Newtons (N)."
  - question: "¿Qué es el kilogramo-fuerza (kgf)?"
    answer: "El kilogramo-fuerza (kgf) es una unidad de fuerza que no pertenece al SI, equivalente a la fuerza gravitacional ejercida sobre una masa de 1 kg en la Tierra (1 kgf = 9.80665 N)."
  - question: "¿Por qué los astronautas se sienten sin peso en el espacio?"
    answer: "Los astronautas a bordo de la Estación Espacial Internacional no están en gravedad cero; están en continua caída libre perpetua junto con su nave espacial, creando una sensación de ingravidez aparente (0 g)."
  - question: "¿Qué es el peso real vs el peso aparente?"
    answer: "El peso real es la fuerza de atracción gravitacional real W = mg. El peso aparente es la fuerza de contacto normal neta que empuja hacia atrás contra un cuerpo (que cambia en ascensores acelerados o vuelos parabólicos)."
  - question: "¿Cómo cambia tu peso en un ascensor acelerando hacia arriba?"
    answer: "Cuando un ascensor acelera hacia arriba con aceleración 'a', tu peso aparente aumenta: W_aparente = m · (g + a)."
  - question: "¿Cómo cambia tu peso en un ascensor acelerando hacia abajo?"
    answer: "Cuando un ascensor acelera hacia abajo con aceleración 'a', tu peso aparente disminuye: W_aparente = m · (g - a)."
  - question: "¿Qué pasa con tu peso si los cables del ascensor se rompen?"
    answer: "Si los cables se rompen, el ascensor cae a a = g, por lo que el peso aparente se convierte en W_aparente = m · (g - g) = 0 N (caída libre de cero G)."
  - question: "¿Cómo varía la gravedad de la Tierra del ecuador a los polos?"
    answer: "Debido al ensanchamiento ecuatorial de la Tierra y la rotación centrífuga, la gravedad es ligeramente más débil en el ecuador (~9.78 m/s²) y más fuerte en los polos (~9.83 m/s²)."
  - question: "¿Cómo afecta la altitud al peso?"
    answer: "La gravedad disminuye con la altitud según g = G·M / (r + h)². A una altitud de 400 km (órbita de la ISS), la gravedad sigue siendo ~8.7 m/s² (90% del nivel del mar)."
  - question: "¿Cuál es la fórmula de la Ley de Gravitación Universal de Newton para g?"
    answer: "La gravedad superficial de un planeta celestial se calcula usando g = G · M / R², donde G es la constante gravitacional (6.674×10⁻¹¹ N·m²/kg²), M es la masa del planeta, y R es el radio del planeta."
  - question: "¿Cuál es el peso de una mochila de 10 kg en la Tierra?"
    answer: "Una mochila de 10 kg pesa W = 10 · 9.81 = 98.1 Newtons (22.5 lbf)."
  - question: "¿Cuál es el peso de un automóvil de 1,500 kg en la Tierra?"
    answer: "Un automóvil de 1,500 kg pesa W = 1,500 · 9.81 = 14,715 Newtons (14.72 kN o 3,308 lbf)."
  - question: "¿Cuál es el peso de un contenedor de envío de 30,000 kg en la Tierra?"
    answer: "Un contenedor de 30,000 kg pesa W = 30,000 · 9.81 = 294,300 Newtons (294.3 kN)."
  - question: "¿Cuál es el peso de un elefante de 6,000 kg en la Tierra?"
    answer: "Un elefante de 6,000 kg pesa W = 6,000 · 9.81 = 58,860 Newtons (58.86 kN)."
  - question: "¿Cuál es el peso de un cohete Starship de 5,000,000 kg totalmente lleno de combustible en la Tierra?"
    answer: "Un cohete de 5,000,000 kg pesa W = 5,000,000 · 9.81 = 49,050,000 Newtons (49.05 MN o 11.03 millones de lbf)."
  - question: "¿Cuánto empuje debe producir un cohete para despegar de la Tierra?"
    answer: "Para despegar, un cohete debe generar un empuje mayor que su peso gravitacional total (Empuje > W = mg)."
  - question: "¿Cuál es la relación empuje-peso en la industria aeroespacial?"
    answer: "La relación empuje a peso (T/W = Empuje / Peso) debe exceder 1.0 para que un cohete acelere verticalmente fuera de la plataforma de lanzamiento."
  - question: "¿Es el peso una cantidad escalar o vectorial?"
    answer: "El peso es una cantidad vectorial porque tiene tanto magnitud (N) como una dirección que apunta hacia el centro de atracción gravitacional."
  - question: "¿Es la masa una cantidad escalar o vectorial?"
    answer: "La masa es una cantidad escalar porque tiene magnitud (kg) pero no dirección."
  - question: "¿Cambia la masa en la Luna?"
    answer: "¡No! Un humano de 70 kg tiene una masa de 70 kg en la Tierra, 70 kg en la Luna, 70 kg en Marte y 70 kg en el espacio profundo."
  - question: "¿Por qué el peso de la báscula se mide en kg en la vida cotidiana?"
    answer: "Las básculas de baño miden la fuerza hacia abajo (peso), pero están calibradas asumiendo la gravedad estándar de la Tierra (9.81 m/s²) para mostrar la masa equivalente en kg."
  - question: "¿Cuál es el peso en una estrella de neutrones?"
    answer: "La gravedad superficial en una estrella de neutrones es ~2 × 10¹² m/s² (200 mil millones de veces la gravedad de la Tierra). ¡Un humano de 70 kg pesaría 140 billones de Newtons!"
  - question: "¿Cuál es el peso en el Sol?"
    answer: "La gravedad de la superficie del Sol es 274 m/s² (~28 veces la gravedad de la Tierra). Un humano de 70 kg pesaría 19,180 Newtons en la superficie del Sol."
  - question: "¿Cuál es el error común de los estudiantes en los cálculos de peso?"
    answer: "Los errores comunes incluyen confundir la masa (kg) con la fuerza del peso (N), usar el valor de gravedad del planeta equivocado o olvidar multiplicar la masa por 9.81."
  - question: "¿Cómo miden el peso las balanzas de resorte?"
    answer: "Las balanzas de resorte miden la extensión causada por la fuerza de peso gravitacional hacia abajo según la Ley de Hooke (F = k · x)."
  - question: "¿Cómo miden la masa las balanzas digitales?"
    answer: "Las balanzas analíticas comparan el peso del objeto desconocido contra masas internas de referencia conocidas, leyendo la masa con precisión independientemente de los cambios menores en la gravedad local."
  - question: "¿Qué es la fuerza G en acrobacias y aviones de combate?"
    answer: "La fuerza G mide la aceleración en relación con la gravedad de la Tierra. 1 G es igual a 9.81 m/s². Una maniobra de 9G multiplica el peso aparente sentido por 9."
  - question: "¿Qué es la microgravedad?"
    answer: "La microgravedad describe entornos donde las fuerzas de aceleración neta son extremadamente pequeñas (~10⁻⁶ g), como las estaciones espaciales orbitales en caída libre."
  - question: "¿Cómo afecta la gravedad al peso del aire en la atmósfera de la Tierra?"
    answer: "El peso de la columna atmosférica de la Tierra crea una presión atmosférica a nivel del mar de 101,325 Pascales (14.7 psi o 1.03 kgf/cm²)."
  - question: "¿Qué es el centro de gravedad (CG) vs centro de masa (CM)?"
    answer: "El centro de masa es la posición promedio de la distribución de masa. El centro de gravedad es el punto donde actúa la fuerza de peso gravitacional total. En gravedad uniforme, el CM y el CG son idénticos."
  - question: "¿Cómo depende el período de un péndulo de la gravedad?"
    answer: "El período de un péndulo simple es T = 2π · √(L / g). Una gravedad mayor (g) acorta el período de oscilación, haciendo que el reloj marque más rápido."
  - question: "¿Por qué saltar en la Luna alcanza alturas mayores?"
    answer: "Debido a que la gravedad de la Luna es 1/6 de la gravedad de la Tierra (1.62 m/s²), ¡la misma fuerza de empuje de las piernas lanza a un astronauta ~6 veces más alto en el cielo lunar!"
  - question: "¿Cuál es el peso en la luna de Saturno, Titán?"
    answer: "La gravedad superficial de Titán es de 1.352 m/s² (aproximadamente el 14% de la gravedad de la Tierra). Combinado con una atmósfera densa (1.45 bar), ¡un humano con alas sintéticas podría volar fácilmente!"
---
...
```mermaid
flowchart LR
    A[Fórmula Central:<br/>Peso = Masa * Gravedad] --> B{¿Qué es<br/>Desconocido?}
    
    B -->|Necesita Peso| C[Multiplicar Masa por Gravedad<br/>W = m * g]
    B -->|Necesita Masa| D[Dividir Peso por Gravedad<br/>m = W / g]
    B -->|Necesita Gravedad| E[Dividir Peso por Masa<br/>g = W / m]
...
```mermaid
xychart-beta
    title "Aceleración Gravitacional Terrestre vs Altitud sobre el Nivel del Mar"
    x-axis "Altitud sobre la Superficie de la Tierra (km)" [0, 1000, 2000, 3000, 4000, 5000]
    y-axis "Gravedad (m/s²)" 0 --> 10
