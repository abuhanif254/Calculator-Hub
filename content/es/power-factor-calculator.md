---
title: "Calculadora de Factor de Potencia | Solucionador de Corrección y Dimensionamiento de Capacitores"
description: "Calculadora de Factor de Potencia gratuita en línea. Calcule instantáneamente el factor de potencia (PF), potencia real (kW), potencia aparente (kVA), potencia reactiva (kVAR), ángulo de fase, corriente CA monofásica y trifásica, corrección del factor de potencia y dimensionamiento del banco de capacitores."
metaTitle: "Calculadora de Factor de Potencia | Solucionador de Corrección y Dimensionamiento de Capacitores"
metaDescription: "Calculadora de Factor de Potencia gratuita en línea. Calcule instantáneamente el factor de potencia (PF), potencia real (kW), potencia aparente (kVA), potencia reactiva (kVAR), ángulo de fase, corriente CA monofásica y trifásica, corrección del factor de potencia y dimensionamiento del banco de capacitores."
metaKeywords: "calculadora de factor de potencia, calculadora de pf, calculadora de corrección de factor de potencia, calculadora de potencia reactiva, calculadora de potencia aparente, dimensionamiento de banco de capacitores, calculadora de factor de potencia trifásica"
features:
  - "Cabina interactiva con alternancia entre Modo Simple y Avanzado"
  - "5 Pestañas de Categoría de Funciones: Solucionador Básico de PF de CA, Corrección de PF y Dimensionamiento de Capacitores, Panel de Comparación Antes/Después, Agregación de Vectores de Carga Múltiple y Utilización de Motores/Transformadores"
  - "📐 Diagrama de Triángulo de Potencia SVG Dinámico e Interactivo que muestra la Potencia Real (P), Potencia Reactiva (Q), Potencia Aparente (S) y Ángulo de Fase (φ)"
  - "🔄 Diagrama de Vector Fasorial Interactivo que ilustra el Voltaje (V) vs la Corriente (I) para alineación en Adelanto, en Atraso o Unitaria"
  - "🏢 Constructor de Agregación de Vectores de Carga Múltiple (ΣP + jΣQ) que evita el promedio aritmético incorrecto"
  - "🔋 Dimensionamiento del Banco de Capacitores en Microfaradios (μF) para Sistemas de 50Hz y 60Hz en Topologías Delta (Δ) o Estrella (Y)"
  - "📊 Análisis de Corrección Antes vs Después que muestra el % de reducción de corriente de línea y la capacidad del transformador kVA liberada"
  - "Generador de Cuestionarios de Práctica con problemas aleatorios de ingeniería de factor de potencia y derivaciones matemáticas paso a paso"
useCases:
  - "Ingenieros eléctricos que diseñan bancos de capacitores para la corrección del factor de potencia en instalaciones de fabricación industrial"
  - "Gerentes de instalaciones que reducen los recargos de penalización por potencia reactiva de la red pública y liberan capacidad de transformadores"
  - "Electricistas y técnicos de sistemas de energía que dimensionan pasos de capacitores trifásicos de 480V y 400V"
  - "Estudiantes de ingeniería que visualizan triángulos de potencia real, reactiva y aparente, y ángulos de fase"
howToSteps:
  - "Seleccione su Tipo de Sistema de CA (Monofásico o Trifásico Línea a Línea) e ingrese el Voltaje del Sistema (V)."
  - "Ingrese la Potencia Real (P en kW) y el Factor de Potencia inicial (PF)."
  - "Especifique su Factor de Potencia Objetivo (por ejemplo, 0.95 o 0.98) y la Frecuencia (50Hz o 60Hz)."
  - "Observe el Triángulo de Potencia Interactivo, la Compensación Requerida (Qc en kVAR) y los Microfaradios (μF) por fase."
  - "Utilice el Panel Antes/Después para inspeccionar el % de reducción de la corriente de línea y la liberación de capacidad del transformador."
  - "Haga clic en 'Copiar Resumen' o 'Imprimir PDF' para guardar su informe de análisis de ingeniería eléctrica."
faqs:
  - question: "¿Qué es el Factor de Potencia (PF)?"
    answer: "El Factor de Potencia es la relación entre la Potencia Real (kW) consumida realmente para realizar trabajo y la Potencia Aparente (kVA) suministrada al circuito (PF = P / S = cos φ). Mide la eficiencia de la energía eléctrica de CA."
  - question: "¿Cuál es la fórmula del Factor de Potencia?"
    answer: "Factor de Potencia PF = Potencia Real P (kW) / Potencia Aparente S (kVA). Alternativamente, PF = cos(φ), donde φ es el ángulo de desfase entre el voltaje y la corriente de CA."
  - question: "¿Cuál es la diferencia entre Potencia Real, Potencia Reactiva y Potencia Aparente?"
    answer: "La Potencia Real P (kW) realiza el trabajo real (calor, luz, movimiento). La Potencia Reactiva Q (kVAR) sostiene los campos electromagnéticos en motores y transformadores. La Potencia Aparente S (kVA) es la combinación vectorial total de ambas (S = √(P² + Q²))."
  - question: "¿Qué es un factor de potencia en atraso?"
    answer: "Un factor de potencia en atraso ocurre en cargas inductivas (motores, transformadores, inductores) donde la forma de onda de la corriente se retrasa con respecto a la forma de onda del voltaje (ángulo de fase φ > 0)."
  - question: "¿Qué es un factor de potencia en adelanto?"
    answer: "Un factor de potencia en adelanto ocurre en cargas capacitivas (bancos de capacitores, cables de transmisión largos) donde la forma de onda de la corriente se adelanta a la forma de onda del voltaje (ángulo de fase φ < 0)."
  - question: "¿Qué es el factor de potencia unitario?"
  ...
  - question: "¿Cómo se calcula el tamaño del banco de capacitores en Microfaradios (μF)?"
    answer: "Para monofásico: C = (Qc × 1000) / (2π f V²). Para trifásico Delta: C_delta = (Qc × 1000) / (3 × 2π f V_L²). Para trifásico Estrella: C_wye = (Qc × 1000) / (2π f V_L²)."
  - question: "¿Cómo calcular la corriente de línea en un sistema de CA trifásico?"
    answer: "Corriente de Línea I_L = (P × 1000) / (√3 × V_L × PF), donde P es kW, V_L es el Voltaje Línea a Línea, y PF es el Factor de Potencia."
  - question: "¿Cómo calcular la corriente de línea en un sistema de CA monofásico?"
    answer: "Corriente de Línea I = (P × 1000) / (V × PF), donde P es kW, V es el Voltaje, y PF es el Factor de Potencia."
  - question: "¿Cuánto puede reducir la corriente de línea la corrección del factor de potencia?"
    answer: "Mejorar el PF de 0.75 a 0.95 reduce la corriente de línea en aproximadamente un 21%, reduciendo las pérdidas por calentamiento de los cables (I²R) en casi un 37%."
  - question: "¿Por qué no se pueden simplemente promediar los factores de potencia al combinar varias cargas?"
    answer: "El factor de potencia es una relación trigonométrica no lineal (cos φ). Varias cargas deben sumarse agregando la Potencia Real total (ΣP) y la Potencia Reactiva total (ΣQ), luego calculando PF_total = ΣP / √( (ΣP)² + (ΣQ)² )."
  - question: "¿Qué es el Triángulo de Potencia?"
    answer: "El Triángulo de Potencia es un triángulo rectángulo que representa la relación vectorial entre la Potencia Real P (base horizontal), la Potencia Reactiva Q (perpendicular vertical) y la Potencia Aparente S (hipotenusa)."
  - question: "¿Cuál es la diferencia entre el Factor de Potencia de Desplazamiento y el Factor de Potencia Real?"
    answer: "El PF de Desplazamiento se basa únicamente en el desplazamiento de fase fundamental de 50Hz/60Hz (cos φ1). El PF Real tiene en cuenta la distorsión armónica total (THD) causada por la electrónica no lineal (PF Real = PF de Desplazamiento × Factor Armónico)."
  - question: "¿Qué es una advertencia de distorsión armónica para bancos de capacitores?"
    answer: "Las cargas no lineales (VFDs, fuentes de alimentación conmutadas) generan corrientes armónicas. Los bancos de capacitores estándar pueden resonar con la inductancia del sistema en frecuencias armónicas, causando destrucción por sobrevoltaje."
  - question: "¿Qué es el filtrado de banco de capacitores desintonizado?"
    answer: "Los bancos de capacitores desintonizados conectan reactores en serie (inductores) con capacitores para desplazar la frecuencia resonante por debajo del armónico más bajo (por ejemplo, el quinto armónico de 300Hz), evitando la amplificación armónica."
  - question: "¿Cuál es el factor de potencia objetivo para instalaciones industriales?"
    answer: "Las instalaciones industriales suelen apuntar a un factor de potencia de entre 0.95 y 0.98 en atraso para evitar recargos de penalización de la red pública sin arriesgarse a una sobrecorrección de PF en adelanto."
  - question: "¿Qué sucede si un sistema se corrige en exceso a un factor de potencia en adelanto?"
    answer: "Sobrecorregir a un PF en adelanto (PF < 1.0 en adelanto) puede causar inestabilidad en el voltaje del generador, un aumento de voltaje alto no deseado durante condiciones de carga ligera y el disparo de los relés de protección."
  - question: "¿Cómo la mejora del factor de potencia libera capacidad kVA del transformador?"
    answer: "La capacidad del transformador se clasifica en kVA (S = P / PF). Elevar el PF de 0.75 a 0.95 para una carga de 100 kW reduce la demanda de kVA de 133.3 kVA a 105.3 kVA, liberando 28 kVA de espacio libre en el transformador."
  - question: "¿Qué es la corrección automática del factor de potencia (APFC)?"
    answer: "Un panel APFC utiliza un controlador con microprocesador para cambiar automáticamente los pasos de los bancos de capacitores en respuesta a las cargas de los motores inductivos cambiantes, manteniendo un PF objetivo estable."
  - question: "¿Cuál es el ángulo de fase para un factor de potencia de 0.80?"
    answer: "φ = arccos(0.80) = 36.87 grados (0.6435 radianes)."
  - question: "¿Cuál es el factor de potencia de las cargas resistivas puras (calentadores, lámparas incandescentes)?"
    answer: "Las cargas resistivas puras tienen un factor de potencia de 1.0 (PF unitario, 0 kVAR de potencia reactiva, ángulo de fase 0°)."
  - question: "¿Cuál es el factor de potencia típico de un motor de inducción no corregido?"
    answer: "Un motor de inducción trifásico no corregido opera de 0.80 a 0.88 PF a plena carga, y tan bajo como de 0.20 a 0.50 PF cuando está en ralentí o con carga ligera."
  - question: "¿Cuál es el factor de potencia de las modernas fuentes de alimentación de computadora conmutadas?"
    answer: "Las PSU modernas de computadoras con Corrección de Factor de Potencia Activa (PFC Activo) operan a un factor de potencia de 0.95 a 0.99."
  - question: "¿La corrección del factor de potencia reduce las facturas eléctricas residenciales?"
    answer: "Por lo general, no. Los medidores eléctricos residenciales solo facturan la energía de Potencia Real (kWh), no la demanda de kVA o kVAR. El PFC beneficia a las instalaciones comerciales e industriales sujetas a tarifas de facturación de kVA/kVAR."
  - question: "¿Qué es kVARh (Kilovar-hora)?"
    answer: "El kVARh mide la energía reactiva acumulada consumida a lo largo del tiempo, utilizada por los medidores de servicios industriales para calcular las tarifas de penalización por factor de potencia."
  - question: "¿Qué clasificación de voltaje deben tener los capacitores utilizados para la corrección trifásica de 480V?"
    answer: "Para sistemas de 480V, se recomiendan capacitores con clasificación de 525V o 600V para proporcionar un margen de seguridad contra picos de sobrevoltaje armónico."
  - question: "¿Cuál es la relación entre kVA, kW y kVAR?"
    answer: "(kVA)² = (kW)² + (kVAR)². Por lo tanto, kVA = √( kW² + kVAR² )."
---
...
```mermaid
flowchart LR
    A["Potencia Real (kW)<br/>Vector de Trabajo Horizontal"] --> B{"Suma Vectorial<br/>Desfase Angular"}
    
    C["Potencia Reactiva (kVAR)<br/>Vector Magnético Vertical"] --> B
    
    B --> D["Potencia Aparente (kVA)<br/>Carga Total de la Red"]
...
```mermaid
xychart-beta
    title "Recargo de Penalización de la Red Pública vs Factor de Potencia"
    x-axis "Factor de Potencia (PF)" [0.95, 0.90, 0.85, 0.80, 0.75, 0.70]
    y-axis "Porcentaje de Recargo de Penalización" 0 --> 25
    bar [0, 0, 5, 10, 18, 25]
```
...
```mermaid
flowchart TD
    A["Extraer Datos de Referencia<br/>P=100kW, PF=0.75"] --> B{"Ejecutar Cálculos<br/>de Compensación"}
    
    B --> C["Calcular Ángulo Inicial<br/>tan(41.4 deg) = 0.88"]
    B --> D["Calcular Ángulo Objetivo<br/>tan(18.2 deg) = 0.33"]
    
    C --> E["Ejecutar Fórmula<br/>Qc = 100 x (0.88 - 0.33)"]
    D --> E
    
    E --> F["Resultado: 55 kVAR requeridos"]
    F --> G["Selección Final:<br/>Instalar Banco de 60 kVAR"]
...
```mermaid
gantt
    title Retraso de la Forma de Onda de CA (Voltaje vs Retraso de Corriente)
    dateFormat  YYYY-MM-DD
    axisFormat  %H:%M
    
    section Forma de Onda de Voltaje
    El Voltaje Cruza por Cero y Alcanza el Pico :crit, 2026-01-01 00:00, 1h
    
    section Forma de Onda de Corriente
    La Corriente es Retrasada por el Inductor :active, 2026-01-01 01:00, 1h
    
    section Ángulo de Fase
    La Brecha de Tiempo crea el Ángulo de Fase :done, 2026-01-01 02:00, 1h
```
