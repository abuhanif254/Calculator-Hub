---
title: "Calculateur d'Énergie Potentielle | Solveur d'Énergie Gravitationnelle (EP = mgh)"
description: "Calculateur d'énergie potentielle en ligne gratuit. Résolvez instantanément EP = mgh, explorez 10 préréglages de gravité planétaire, simulez la conversion d'énergie en chute libre et convertissez les unités d'énergie en J, kJ, MJ et kWh."
metaTitle: "Calculateur d'Énergie Potentielle | Solveur d'Énergie Gravitationnelle (EP = mgh)"
metaDescription: "Calculateur d'énergie potentielle en ligne gratuit. Résolvez instantanément EP = mgh, explorez 10 préréglages de gravité planétaire, simulez la conversion d'énergie en chute libre et convertissez les unités d'énergie en J, kJ, MJ et kWh."
metaKeywords: "calculateur d'énergie potentielle, calculateur ep, calculateur d'énergie potentielle gravitationnelle, calculateur ep mgh, formule de l'énergie potentielle, pôle d'énergie mécanique"
features:
  - "Cockpit interactif du potentiel comprenant une bascule entre le mode Simple et Avancé"
  - "Résout pour l'Énergie Potentielle (EP = mgh), la Masse (m = EP/gh), la Hauteur (h = EP/mg) ou la Gravité (g = EP/mh)"
  - "🔄 Barre supérieure du pôle d'énergie mécanique permettant de basculer rapidement entre l'Énergie Potentielle, l'Énergie Cinétique, le Travail, la Puissance et la Quantité de mouvement"
  - "🪐 10 préréglages de planètes du système solaire (Terre, Lune, Mars, Mercure, Vénus, Jupiter, Saturne, Uranus, Neptune, Pluton)"
  - "⚡ Simulateur de chute libre Énergie Potentielle ↔ Énergie Cinétique affichant la conversion EP vers EC et la vitesse d'impact terminale"
  - "🎯 Préréglages du monde réel (Livre sur une table, Personne sur une échelle, Bâtiment, Montagne, Grue à tour, Montagnes russes, Château d'eau, Barrage, Fusée)"
  - "Jauge d'énergie en arc radial logarithmique catégorisant les niveaux d'énergie"
  - "Générateur de quiz de physique pour s'entraîner avec des problèmes d'énergie aléatoires et des dérivations mathématiques étape par étape"
useCases:
  - "Les étudiants et professeurs de physique pour dériver l'énergie potentielle gravitationnelle, la conservation de l'énergie mécanique et la chute libre"
  - "Les ingénieurs civils et mécaniques pour calculer les capacités de charge des grues, des échafaudages et des châteaux d'eau surélevés"
  - "Les ingénieurs en production d'énergie hydroélectrique pour déterminer l'énergie de l'eau stockée derrière les barrages (EP = mgh)"
  - "Les architectes de montagnes russes pour calculer la hauteur maximale des collines et les vitesses maximales théoriques (v = √(2gh))"
howToSteps:
  - "Sélectionnez votre mode de calcul cible : Énergie Potentielle (EP), Masse (m), Hauteur (h) ou Gravité (g)."
  - "Saisissez vos valeurs connues dans les champs de saisie ou ajustez les curseurs de plage interactifs."
  - "Choisissez votre système d'unités préféré (par ex. Joules, Kilojoules, Mégajoules, Kilogrammes, mètres, pieds, m/s²)."
  - "Sélectionnez éventuellement un préréglage de planète (Terre, Lune, Mars, Jupiter) pour tester les champs d'accélération gravitationnelle."
  - "Activez le mode Avancé pour inspecter le simulateur de conversion d'énergie en chute libre, l'explorateur de gravité planétaire et les graphiques."
  - "Exportez votre résumé de calcul via l'impression PDF, copiez le texte formaté ou partagez un lien de paramètre personnalisé."
faqs:
  - question: "Qu'est-ce que l'énergie potentielle en physique ?"
    answer: "L'énergie potentielle est l'énergie stockée que possède un objet en raison de sa position, de sa hauteur ou de sa configuration interne dans un champ de force (par ex. le champ gravitationnel)."
  - question: "Quelle est la formule de l'énergie potentielle gravitationnelle ?"
    answer: "La formule de l'énergie potentielle gravitationnelle près de la surface de la Terre est EP = m · g · h, où m est la masse, g est l'accélération gravitationnelle et h est la hauteur verticale."
  - question: "Quelle est l'unité SI de l'énergie potentielle ?"
    answer: "L'unité SI de l'énergie potentielle est le Joule (J), défini comme 1 kg·m²/s² ou 1 Newton-mètre (N·m)."
  - question: "L'énergie potentielle est-elle scalaire ou vectorielle ?"
    answer: "L'énergie potentielle est une grandeur scalaire, ne possédant qu'une magnitude."
  - question: "Quelle est l'accélération standard due à la gravité sur Terre ?"
    answer: "L'accélération standard terrestre due à la gravité (g) est d'environ 9,80665 m/s² (communément arrondie à 9,81 m/s² ou 32,2 ft/s²)."
  - question: "Comment calcule-t-on la masse à partir de l'énergie potentielle, de la hauteur et de la gravité ?"
    answer: "La masse se calcule avec la formule m = EP / (g · h)."
  - question: "Comment calcule-t-on la hauteur à partir de l'énergie potentielle, de la masse et de la gravité ?"
    answer: "La hauteur se calcule avec la formule h = EP / (m · g)."
  - question: "Comment calcule-t-on la gravité à partir de l'énergie potentielle, de la masse et de la hauteur ?"
    answer: "La gravité se calcule avec la formule g = EP / (m · h)."
  - question: "Que se passe-t-il avec l'énergie potentielle si la hauteur est doublée ?"
    answer: "Puisque l'EP dépend linéairement de la hauteur (h), doubler la hauteur double (2x) l'énergie potentielle."
  - question: "Que se passe-t-il avec l'énergie potentielle si la masse est doublée ?"
    answer: "Puisque l'EP dépend linéairement de la masse (m), doubler la masse double (2x) l'énergie potentielle."
  - question: "Qu'est-ce que la loi de la conservation de l'énergie mécanique ?"
    answer: "Dans un système isolé sans frottement ni résistance de l'air, l'énergie mécanique totale reste constante : EP_initiale + EC_initiale = EP_finale + EC_finale."
  - question: "Comment l'énergie potentielle est-elle convertie en énergie cinétique lors d'une chute libre ?"
    answer: "Lorsqu'un objet tombe d'une hauteur h, son énergie potentielle diminue tandis que son énergie cinétique augmente d'une quantité égale (ΔEC = -ΔEP)."
  - question: "Quelle est la vitesse d'impact terminale d'un objet lâché ?"
    answer: "En ignorant la résistance de l'air, la vitesse d'impact terminale au niveau du sol (h = 0) est v_impact = √(2 · g · h)."
  - question: "Quelle est la gravité sur la Lune ?"
    answer: "L'accélération gravitationnelle sur la Lune est d'environ 1,62 m/s² (~16,5 % de la gravité terrestre)."
  - question: "Quelle est la gravité sur Mars ?"
    answer: "L'accélération gravitationnelle sur Mars est d'environ 3,71 m/s² (~38 % de la gravité terrestre)."
  - question: "Quelle est la gravité sur Jupiter ?"
    answer: "L'accélération gravitationnelle au sommet des nuages de Jupiter est d'environ 24,79 m/s² (~253 % de la gravité terrestre)."
  - question: "Qu'est-ce que l'énergie potentielle élastique ?"
    answer: "L'énergie potentielle élastique est l'énergie stockée dans un ressort déformé ou un matériau élastique, calculée comme EP_ressort = ½ · k · x², où k est la constante de raideur et x le déplacement."
  - question: "Qu'est-ce que l'énergie potentielle chimique ?"
    answer: "L'énergie potentielle chimique est l'énergie stockée dans les liaisons chimiques entre les atomes, libérée lors des réactions chimiques."
  - question: "Qu'est-ce que l'énergie potentielle électrique ?"
    answer: "L'énergie potentielle électrique est l'énergie stockée par une charge électrique placée dans un champ électrostatique (EP_électrique = q · V)."
  - question: "Quel est le niveau de référence (datum) dans l'énergie potentielle ?"
    answer: "Le niveau de référence ou datum est la hauteur de base où l'énergie potentielle est arbitrairement fixée à zéro (généralement le niveau du sol ou de la mer)."
  - question: "L'énergie potentielle peut-elle être négative ?"
    answer: "Oui ! Si un objet est situé en dessous de la hauteur de référence zéro choisie (par ex. dans une fosse ou une tranchée), son énergie potentielle gravitationnelle est négative par rapport au niveau du sol."
  ...
  - question: "Combien de Joules y a-t-il dans 1 Mégajoule (MJ) ?"
    answer: "1 Mégajoule (MJ) équivaut à 1 000 000 Joules."
  ...
  - question: "Quelle énergie potentielle possède un livre sur un bureau de 0,75 m ?"
    answer: "Un livre de 1,5 kg sur un bureau de 0,75 m de haut a une énergie potentielle de EP = 1,5 · 9,81 · 0,75 = 11,04 Joules."
  - question: "Quelle énergie potentielle possède une personne sur une échelle de 3 m ?"
    answer: "Une personne de 75 kg sur une échelle de 3 m a une énergie potentielle de EP = 75 · 9,81 · 3 = 2 207,25 Joules (~2,21 kJ)."
  - question: "Quelle énergie potentielle possède un château d'eau sur un toit ?"
    answer: "Un réservoir d'eau de 1 000 kg placé sur un toit de 15 m a une énergie potentielle de EP = 1000 · 9,81 · 15 = 147 150 Joules (~147,15 kJ)."
  - question: "Quelle énergie potentielle possèdent des montagnes russes à un pic de 45 m ?"
    answer: "Un train de montagnes russes de 800 kg à un pic de 45 m a une énergie potentielle de EP = 800 · 9,81 · 45 = 353 160 Joules (~353,16 kJ)."
  - question: "Quelle énergie potentielle l'eau stockée derrière un barrage hydroélectrique possède-t-elle ?"
    answer: "100 000 kg d'eau stockés à 100 m de hauteur derrière un barrage hydroélectrique contiennent EP = 100 000 · 9,81 · 100 = 98 100 000 Joules (98,1 MJ)."
  - question: "Comment un barrage hydroélectrique transforme-t-il l'énergie potentielle en électricité ?"
    answer: "L'énergie potentielle de l'eau stockée (EP = mgh) se convertit en énergie cinétique lorsque l'eau tombe dans les conduites forcées pour faire tourner les turbines hydroélectriques connectées aux générateurs électriques."
  - question: "Qu'est-ce que l'hydroélectricité par pompage-turbinage ?"
    answer: "L'hydroélectricité par pompage-turbinage agit comme une batterie d'eau géante, pompant l'eau vers un réservoir supérieur pendant les heures creuses bon marché et la relâchant pour produire de l'énergie pendant les pics de demande."
  - question: "Comment les montagnes russes dépendent-elles de l'énergie potentielle ?"
    answer: "Un train de montagnes russes est tiré jusqu'à son plus haut sommet pour accumuler une énergie potentielle maximale. La gravité convertit ensuite cette EP en énergie cinétique pour propulser le train à travers les boucles et les virages."
  - question: "Qu'est-ce que l'énergie potentielle gravitationnelle universelle ?"
    answer: "Sur des distances astronomiques, l'énergie potentielle gravitationnelle universelle est EP = -G · M · m / r, où G est la constante gravitationnelle, M et m sont les masses, et r est la distance de séparation."
  - question: "Pourquoi l'énergie potentielle gravitationnelle universelle est-elle négative ?"
    answer: "Parce que l'énergie potentielle zéro est définie à une distance de séparation infinie (r = ∞), les forces de gravité attractives nécessitent un travail positif pour séparer les masses, rendant l'EP négative à des distances finies."
  - question: "Qu'est-ce que la vitesse de libération en termes d'énergie potentielle ?"
    answer: "La vitesse de libération est la vitesse initiale nécessaire pour que l'énergie cinétique égale la magnitude de l'énergie potentielle gravitationnelle : ½mv² = GMm/r → v_libération = √(2GM/r)."
  - question: "Qu'est-ce que l'oscillation de l'énergie potentielle d'un pendule ?"
    answer: "Aux points les plus hauts de son balancement, un pendule a une énergie potentielle maximale et une énergie cinétique nulle. Au point le plus bas, l'EP est minimale et l'EC est maximale."
  - question: "Comment les grues à tour gèrent-elles la sécurité liée à l'énergie potentielle ?"
    answer: "Les grues à tour disposent de contrepoids, de freins mécaniques et de mécanismes d'arrêt d'urgence pour prévenir la libération catastrophique et incontrôlée de l'énergie potentielle d'une lourde charge."
  - question: "Qu'est-ce que le travail effectué contre la gravité ?"
    answer: "Le travail effectué pour soulever une masse m à une hauteur h contre la gravité est égal à W = F · h = (m · g) · h = ΔEP."
  - question: "Le chemin parcouru affecte-t-il le changement d'énergie potentielle gravitationnelle ?"
    answer: "Non ! La gravité est une force conservative, de sorte que le changement d'énergie potentielle ne dépend que des hauteurs verticales initiale et finale, quels que soient les chemins courbes ou en zigzag empruntés."
  - question: "Quelle est la différence entre l'énergie potentielle et l'énergie cinétique ?"
    answer: "L'énergie potentielle est l'énergie stockée due à la position ou à la hauteur, tandis que l'énergie cinétique est l'énergie du mouvement."
  - question: "Qu'est-ce que l'énergie mécanique totale ?"
    answer: "L'énergie mécanique totale est E_totale = EP + EC."
  - question: "La résistance de l'air affecte-t-elle la valeur de l'énergie potentielle ?"
    answer: "Non. La résistance de l'air affecte l'énergie cinétique et la dissipation thermique pendant le mouvement, mais l'énergie potentielle statique dépend uniquement de la hauteur, de la masse et de la force du champ de gravité local."
  - question: "Comment le saut à la perche convertit-il l'énergie ?"
    answer: "Un perchiste convertit l'énergie cinétique horizontale (course) en énergie potentielle élastique (flexion de la perche), qui se convertit ensuite en énergie potentielle gravitationnelle (franchissement de la barre)."
  - question: "Comment le tir à l'arc convertit-il l'énergie potentielle ?"
    answer: "Bander un arc stocke de l'énergie potentielle élastique dans ses branches. Relâcher la corde convertit l'EP élastique en énergie cinétique pour la flèche."
  - question: "Qu'est-ce que la hauteur du centre de masse dans l'énergie potentielle ?"
    answer: "Pour les objets physiques étendus (comme les bâtiments ou les arbres), l'énergie potentielle est calculée en utilisant la hauteur du centre de masse de l'objet (h_cm)."
  - question: "Comment la gravité varie-t-elle avec l'altitude au-dessus de la Terre ?"
    answer: "La gravité diminue légèrement avec l'altitude selon g(h) = g_surface · (R_terre / (R_terre + h))². Aux altitudes terrestres, g est traité comme constant."
  - question: "Qu'est-ce que le potentiel gravitationnel ?"
    answer: "Le potentiel gravitationnel (V) est l'énergie potentielle par unité de masse : V = EP / m = g · h."
  - question: "Comment une sonnette (mouton de battage) fonctionne-t-elle en utilisant l'énergie potentielle ?"
    answer: "Une sonnette soulève un poids lourd à une hauteur h (accumulation d'EP) et le lâche pour convertir l'EP en énergie cinétique d'impact qui enfonce les pieux de fondation dans le sol."
  - question: "Quelle est l'origine de l'énergie cinétique d'une avalanche ?"
    answer: "La neige accumulée sur les pics montagneux escarpés possède une immense énergie potentielle gravitationnelle, qui se convertit rapidement en une énergie cinétique destructrice lors d'une avalanche."
  - question: "Qu'est-ce que l'énergie potentielle d'un barrage usine marémotrice ?"
    answer: "Les centrales marémotrices retiennent l'eau à marée haute derrière un barrage, créant une hauteur de chute (h) qui libère de l'énergie potentielle à travers les turbines à marée basse."
  - question: "Quelle est l'erreur courante des étudiants dans les calculs d'EP ?"
    answer: "Les erreurs courantes incluent l'utilisation de la distance de la pente au lieu de la hauteur verticale h, l'oubli des unités de gravité locales ou la mauvaise identification de la hauteur de référence zéro."
  - question: "Le champ de gravité dépend-il de la masse de l'objet ?"
    answer: "Non. L'accélération gravitationnelle locale g dépend de la masse et du rayon de la planète, indépendamment de la masse de l'objet soulevé."
  - question: "Comment les haltérophiles exercent-ils un travail pour accumuler de l'énergie potentielle ?"
    answer: "Un haltérophile soulevant des haltères effectue un travail mécanique W = mgh contre la gravité, stockant ce travail sous forme d'énergie potentielle des haltères au verrouillage supérieur."
  - question: "Un objet immobile peut-il avoir de l'énergie potentielle ?"
    answer: "Oui ! Tout objet reposant à une hauteur au-dessus du niveau du sol possède une énergie potentielle gravitationnelle, même s'il est complètement immobile."
---
...
```mermaid
flowchart LR
    A["Masse<br/>5 000 kg"] --> D{"Multiplier<br/>m * g * h"}
    B["Gravité<br/>9,81 m/s²"] --> D
    C["Hauteur<br/>320 m"] --> D
    
    D --> E(("Énergie Potentielle<br/>15,7 Mégajoules"))
...
```mermaid
xychart-beta
    title "Énergie Potentielle de l'Ascenseur vs Hauteur (Masse constante de 2500 kg)"
    x-axis "Hauteur de l'ascenseur (mètres)" [0, 10, 20, 30, 40]
    y-axis "Énergie Potentielle (Kilojoules)" 0 --> 1000
    line [0, 245, 490, 735, 981]
```
...
```mermaid
flowchart TD
    A["Sommet des montagnes russes<br/>Hauteur = 75 m"] -->|"Chute vertigineuse"| B("Mi-chute<br/>Hauteur = 37,5 m")
    B -->|"Accélération maximale"| C["Bas de la chute<br/>Hauteur = 0 m"]
    
    A -.-> D["EP: 5,88 MJ<br/>EC: 0 MJ<br/>Total: 5,88 MJ"]
    B -.-> E["EP: 2,94 MJ<br/>EC: 2,94 MJ<br/>Total: 5,88 MJ"]
    C -.-> F["EP: 0 MJ<br/>EC: 5,88 MJ<br/>Total: 5,88 MJ"]
