---
title: "Calculateur de Chute Libre | Résolveur de Cinématique des Objets en Chute"
description: "Calculateur de Chute Libre gratuit en ligne. Calculez instantanément le temps de chute (t = √(2h/g)), la vitesse d'impact (vf = √(2gh)), explorez 10 préréglages de gravité planétaire et visualisez des simulations de chute animées."
metaTitle: "Calculateur de Chute Libre | Résolveur de Cinématique des Objets en Chute"
metaDescription: "Calculateur de Chute Libre gratuit en ligne. Calculez instantanément le temps de chute (t = √(2h/g)), la vitesse d'impact (vf = √(2gh)), explorez 10 préréglages de gravité planétaire et visualisez des simulations de chute animées."
metaKeywords: "calculateur de chute libre, calculateur d'objet en chute, calculateur de chute de gravité, calculateur de temps de chute libre, calculateur de hauteur de chute, physique des équations cinématiques"
features:
  - "Cockpit interactif de chute libre avec bascule entre le mode simple et avancé"
  - "5 modes de calcul : Temps de chute (t), Vitesse d'impact (vf), Hauteur (h), Gravité (g), Vitesse initiale avancée (vi)"
  - "🎬 Simulateur de toile de chute libre animé affichant la trajectoire de l'objet en chute, la flèche du vecteur vitesse, un minuteur en temps réel et une traînée de particules"
  - "🪐 10 préréglages de planètes du système solaire (Terre, Lune, Mars, Mercure, Vénus, Jupiter, Saturne, Uranus, Neptune, Pluton)"
  - "🎯 Préréglages du monde réel (Lâcher une balle, un livre d'un bureau, un bâtiment, un arbre, un château d'eau, une montagne, un hélicoptère, un drone, un parachutiste)"
  - "📈 Graphiques interactifs de mouvement cinématique traçant la hauteur par rapport au temps et la vitesse par rapport au temps en utilisant Recharts"
  - "Jauge de vitesse d'impact en arc radial logarithmique catégorisant les niveaux de vitesse"
  - "Générateur de quiz de physique pratique avec des problèmes aléatoires de chute libre et des dérivations mathématiques étape par étape"
useCases:
  - "Étudiants et professeurs de physique dérivant des équations cinématiques, la loi de chute libre de Galilée et l'accélération due à la gravité"
  - "Instructeurs de l'aérospatiale et de parachutisme calculant les durées de chute libre non motorisée et les limites de vitesse terminale"
  - "Inspecteurs de la sécurité de la construction calculant les vitesses d'impact des outils tombés des échafaudages ou des grues"
  - "Coordinateurs de cascades cinématographiques déterminant les exigences de profondeur du matelas d'amortissement pour les cascades à haute altitude"
howToSteps:
  - "Sélectionnez votre mode de calcul cible : Temps de chute (t), Vitesse d'impact (vf), Hauteur (h), Gravité (g) ou Avancé (vi)."
  - "Saisissez vos valeurs connues dans les champs de saisie ou ajustez les curseurs de plage interactifs."
  - "Choisissez votre système d'unités préféré (par exemple, mètres, pieds, secondes, m/s, km/h, mph, m/s²)."
  - "Choisissez éventuellement un préréglage de planète (Terre, Lune, Mars, Jupiter) pour tester les champs d'accélération gravitationnelle."
  - "Basculez en mode avancé pour inspecter le simulateur de toile de chute libre, le tableau de comparaison des planètes et les graphiques de mouvement."
  - "Exportez le résumé de votre calcul via l'impression PDF, copiez le texte formaté ou partagez un lien de paramètre personnalisé."
faqs:
  - question: "Qu'est-ce que la chute libre en physique ?"
    answer: "La chute libre est le mouvement d'un objet où la gravité est la seule force qui agit sur lui, l'accélérant vers le bas à un taux constant (g)."
  - question: "Quelle est la formule du temps de chute libre ?"
    answer: "Pour un objet lâché depuis le repos (v_initiale = 0), le temps de chute libre est t = √(2 · h / g)."
  - question: "Quelle est la formule de la vitesse d'impact finale en chute libre ?"
    answer: "Pour un objet lâché depuis le repos, la vitesse d'impact finale est v_f = √(2 · g · h), ou v_f = g · t."
  - question: "Quelle est la formule de la distance ou de la hauteur de chute libre ?"
    answer: "Pour un objet lâché depuis le repos, la distance parcourue est h = ½ · g · t²."
  - question: "Quelle est l'accélération due à la gravité sur Terre ?"
    answer: "L'accélération standard due à la gravité sur Terre est g = 9,80665 m/s² (couramment arrondie à 9,81 m/s² ou 32,2 ft/s²)."
  - question: "La masse affecte-t-elle la vitesse de chute libre dans le vide ?"
    answer: "Non ! Dans le vide, tous les objets accélèrent exactement au même rythme, indépendamment de leur masse, comme l'a célèbrement démontré Galilée."
  - question: "Pourquoi les plumes tombent-elles plus lentement que les boules de bowling dans l'air ?"
    answer: "La résistance de l'air (traînée aérodynamique) s'oppose au mouvement vers le bas. Les plumes ont une grande surface par rapport à leur poids, créant une forte traînée qui les ralentit."
  - question: "Qu'est-ce que la vitesse terminale ?"
    answer: "La vitesse terminale est la vitesse constante atteinte lorsque la force de traînée aérodynamique vers le haut est égale à la force gravitationnelle vers le bas (accélération nette = 0)."
  - question: "Quelle est la vitesse terminale d'un parachutiste humain ?"
    answer: "Un parachutiste humain, le ventre orienté vers la terre, atteint une vitesse terminale d'environ 54 m/s (120 mph ou 195 km/h)."
  - question: "Comment calcule-t-on la gravité à partir de la hauteur et du temps ?"
    answer: "La gravité se calcule en utilisant g = 2 · h / t²."
  - question: "Comment calculer la chute libre avec une vitesse initiale (v_i) ?"
    answer: "Lorsque la vitesse initiale est non nulle, la hauteur est h = v_i · t + ½ · g · t², et la vitesse finale est v_f = √(v_i² + 2 · g · h)."
  - question: "Quel est le temps de chute libre sur la Lune ?"
    answer: "Comme la gravité de la Lune n'est que de 1,62 m/s², tomber de 20 mètres prend t = √(2 · 20 / 1,62) = 4,97 secondes (contre 2,02 secondes sur Terre)."
  - question: "Quel est le temps de chute libre sur Mars ?"
    answer: "La gravité sur Mars est de 3,71 m/s². Tomber de 20 mètres prend t = √(2 · 20 / 3,71) = 3,28 secondes."
  - question: "Quel est le temps de chute libre sur Jupiter ?"
    answer: "La gravité de Jupiter est de 24,79 m/s². Tomber de 20 mètres prend t = √(2 · 20 / 24,79) = 1,27 secondes."
  - question: "Combien de temps faut-il à une balle pour tomber d'une hauteur de 1,5 mètre ?"
    answer: "Lâchée de 1,5 mètre sur Terre, une balle met t = √(2 · 1,5 / 9,81) = 0,55 seconde pour toucher le sol."
  - question: "Combien de temps un livre met-il à tomber d'un bureau de 0,75 mètre ?"
    answer: "Un livre tombant d'un bureau de 0,75 m met t = √(2 · 0,75 / 9,81) = 0,39 seconde."
  - question: "Combien de temps un objet met-il à tomber d'un immeuble de 10 étages (30 m) ?"
    answer: "Lâché de 30 mètres sur Terre, un objet met t = √(2 · 30 / 9,81) = 2,47 secondes."
  - question: "Quelle est la vitesse d'impact pour une chute de 30 mètres ?"
    answer: "La vitesse d'impact pour 30 mètres est v_f = √(2 · 9,81 · 30) = 24,26 m/s (87,3 km/h ou 54,3 mph)."
  - question: "Qu'est-ce que la loi de la chute libre de Galilée ?"
    answer: "Galilée a prouvé que la distance parcourue par un corps partant du repos est proportionnelle au carré du temps écoulé : h ∝ t²."
  - question: "Quelle était l'expérience de la plume et du marteau d'Apollo 15 ?"
    answer: "En 1971, l'astronaute David Scott a lâché une plume de faucon et un marteau de 1,32 kg sur la Lune. Dans le vide lunaire, les deux ont touché le sol exactement au même instant !"
  - question: "Combien de pieds par seconde au carré vaut la gravité terrestre ?"
    answer: "La gravité standard de la Terre est d'environ 32,174 ft/s²."
  - question: "Comment convertir des m/s en km/h ?"
    answer: "Multipliez les mètres par seconde par 3,6 (par exemple, 10 m/s × 3,6 = 36 km/h)."
  - question: "Comment convertir des m/s en mph ?"
    answer: "Multipliez les mètres par seconde par 2,23694 (par exemple, 10 m/s × 2,23694 = 22,37 mph)."
  - question: "Quelle est l'énergie cinétique acquise pendant une chute libre ?"
    answer: "L'énergie cinétique acquise pendant la chute libre est égale à l'énergie potentielle perdue : EC = ½ · m · v_f² = m · g · h."
  - question: "Le poids change-t-il pendant une chute libre ?"
    answer: "Un objet en chute libre connaît une apparente impesanteur (0 g) car aucune force de contact normale ne le repousse."
  - question: "Qu'est-ce que l'impesanteur ou la microgravité ?"
    answer: "La microgravité se produit lors d'une chute libre continue (par exemple, les astronautes à bord de la Station spatiale internationale en orbite autour de la Terre)."
  - question: "Pourquoi les astronautes sont-ils en apesanteur en orbite ?"
    answer: "Les astronautes ne sont pas en dehors de la gravité terrestre ; ils sont en chute libre perpétuelle continue autour de la Terre à la vitesse orbitale (~7,66 km/s)."
  - question: "Qu'est-ce qu'un manège à tour de chute libre ?"
    answer: "Un manège de tour de chute libre élève les passagers à une hauteur h et libère la nacelle pour une chute libre contrôlée avant que des freins magnétiques ne l'arrêtent en toute sécurité."
  - question: "Quel est le temps de chute libre du saut à l'élastique ?"
    answer: "Lors du saut à l'élastique, le sauteur subit une pure chute libre jusqu'à ce que la corde élastique commence à s'étirer et à exercer une force de tension vers le haut."
  - question: "Comment fonctionne la formule de la résistance de l'air ?"
    answer: "La force de traînée aérodynamique est F_d = ½ · ρ · v² · C_d · A, où ρ est la densité de l'air, C_d est le coefficient de traînée et A est la surface frontale."
  - question: "Comment calculer la formule de la vitesse terminale ?"
    answer: "La vitesse terminale est atteinte lorsque F_d = m·g, ce qui donne v_t = √((2 · m · g) / (ρ · A · C_d))."
  - question: "Que représente la force G en chute libre ?"
    answer: "Pendant une chute libre pure, la force G ressentie est de 0 G. Au repos sur la surface de la Terre, la force G ressentie est de 1 G."
  - question: "Quel est le record du saut en chute libre à haute altitude ?"
    answer: "Alan Eustace détient le record du monde, chutant de 41 419 mètres (135 889 pieds) en 2014, atteignant une vitesse maximale de 1 321 km/h (Mach 1,23) !"
  - question: "Quelle est la force d'impact d'un objet tombé ?"
    answer: "La force d'impact dépend de la vitesse d'impact et de la distance de décélération : F_impact = ½ · m · v_f² / d_arret."
  - question: "Pourquoi les airbags réduisent-ils la force d'impact ?"
    answer: "Les airbags augmentent la distance d'arrêt (d_arret) et le temps, réduisant considérablement la force de décélération maximale lors d'un accident."
  - question: "À quelle hauteur correspond 1 seconde de chute libre sur Terre ?"
    answer: "Après 1 seconde de chute libre à partir du repos sur Terre, la distance parcourue est h = ½ · 9,81 · (1)² = 4,905 mètres (16,1 ft)."
  - question: "À quelle hauteur correspondent 2 secondes de chute libre sur Terre ?"
    answer: "Après 2 secondes de chute libre, la distance parcourue est h = ½ · 9,81 · (2)² = 19,62 mètres (64,4 ft)."
  - question: "À quelle hauteur correspondent 3 secondes de chute libre sur Terre ?"
    answer: "Après 3 secondes de chute libre, la distance parcourue est h = ½ · 9,81 · (3)² = 44,145 mètres (144,8 ft)."
  - question: "À quelle vitesse se déplace un objet après 1 seconde de chute libre ?"
    answer: "Après 1 seconde, la vitesse est v_f = 9,81 m/s (35,3 km/h ou 21,9 mph)."
  - question: "À quelle vitesse se déplace un objet après 2 secondes de chute libre ?"
    answer: "Après 2 secondes, la vitesse est v_f = 19,62 m/s (70,6 km/h ou 43,9 mph)."
  - question: "À quelle vitesse se déplace un objet après 3 secondes de chute libre ?"
    answer: "Après 3 secondes, la vitesse est v_f = 29,43 m/s (106,0 km/h ou 65,8 mph)."
  - question: "Qu'est-ce qu'un avion à vol parabolique Zéro-G ?"
    answer: "Des avions spécialisés (comme la 'Vomit Comet') volent en arcs paraboliques, offrant aux passagers environ 20 secondes de chute libre en apesanteur par parabole."
  - question: "Qu'est-ce que la chute libre dans les sciences du sport ?"
    answer: "Les biomécaniciens du sport analysent la phase de vol en l'air lors du saut en hauteur, de la gymnastique et du plongeon comme un mouvement de chute libre parabolique sous l'effet de la gravité."
  - question: "Comment les grues de construction préviennent-elles les accidents de chute libre ?"
    answer: "Les grues utilisent des freins mécaniques à cliquet, des interrupteurs anti-mouflage et des limiteurs de moment de charge pour éliminer les chutes libres."
  - question: "Quelle est la différence entre la chute libre et le mouvement d'un projectile ?"
    answer: "La chute libre est un mouvement vertical 1D sous l'effet de la gravité, tandis que le mouvement d'un projectile inclut une vitesse horizontale (trajectoire 2D)."
  - question: "Quelle est la vitesse de libération de la Terre ?"
    answer: "La vitesse de libération de la surface de la Terre est d'environ 11,18 km/s (40 270 km/h ou 25 020 mph)."
  - question: "Quelle est la gravité du Soleil ?"
    answer: "La gravité à la surface du Soleil est de 274 m/s² (~28 fois la gravité terrestre)."
  - question: "Qu'est-ce que la chute libre à l'intérieur d'un ascenseur si les câbles se cassent ?"
    answer: "Si les câbles de l'ascenseur lâchent, l'ascenseur et ses occupants tombent à g = 9,81 m/s², créant une brève apesanteur de zéro-G jusqu'à l'engagement des freins de sécurité."
  - question: "Qu'est-ce qu'une installation de tour de chute sous vide ?"
    answer: "La NASA exploite des tours de chute sous vide en impesanteur (par exemple, la tour de chute de 2,2 secondes au centre de recherche Glenn) pour des expériences de microgravité."
  - question: "Quelle est l'erreur courante des étudiants dans les calculs de chute libre ?"
    answer: "Les erreurs courantes incluent l'oubli de mettre le temps au carré dans h = ½gt², la confusion entre la vitesse initiale et la vitesse finale, ou l'ignorance des conversions d'unités."
  - question: "La densité de l'air modifie-t-elle la vitesse terminale à haute altitude ?"
    answer: "Oui ! La densité de l'air ρ est plus faible à haute altitude, ce qui entraîne des vitesses terminales beaucoup plus élevées que près du niveau de la mer."
  - question: "Quelle est la vitesse du son en nombre de Mach ?"
    answer: "La vitesse du son dans l'air au niveau de la mer (15°C) est d'environ 343 m/s (1 235 km/h ou 767 mph), désignée par Mach 1."
---
...
```mermaid
flowchart LR
    A[Connu : Temps<br/>t = 6,5s] --> C{Sélection de l'Équation<br/>h = 0.5 * g * t^2}
    B[Connu : Gravité<br/>g = 9,81 m/s²] --> C
    
    C --> D[Calculer le Carré<br/>t² = 42,25]
    D --> E((Profondeur du Canyon<br/>h = 207,2 mètres))
...
```mermaid
xychart-beta
    title "Distance Parcourue vs Temps (Accélération Parabolique)"
    x-axis "Temps en Chute Libre (Secondes)" [0, 1, 2, 3, 4, 5]
    y-axis "Distance Parcourue (Mètres)" 0 --> 130
...
```mermaid
xychart-beta
    title "Vitesse vs Temps (Accélération Constante de 9,81 m/s²)"
    x-axis "Temps en Chute Libre (Secondes)" [0, 1, 2, 3, 4, 5]
    y-axis "Vitesse vers le Bas (m/s)" 0 --> 50
...
```mermaid
xychart-beta
    title "Chute Libre dans le Vide vs. Vitesse Terminale Atmosphérique"
    x-axis "Temps en Chute Libre (Secondes)" [0, 4, 8, 12, 16, 20]
    y-axis "Vitesse vers le Bas (m/s)" 0 --> 200
