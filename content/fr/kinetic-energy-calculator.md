---
title: "Calculateur d'Énergie Cinétique | Résolveur d'Énergie de Mouvement (EC = ½mv²)"
description: "Calculateur d'Énergie Cinétique gratuit en ligne. Résolvez instantanément EC = ½mv², analysez les graphiques d'impact quadratique de la vitesse, convertissez les unités entre J, kJ, MJ et kWh, et explorez le mouvement dans le monde réel."
metaTitle: "Calculateur d'Énergie Cinétique | Résolveur d'Énergie de Mouvement (EC = ½mv²)"
metaDescription: "Calculateur d'Énergie Cinétique gratuit en ligne. Résolvez instantanément EC = ½mv², analysez les graphiques d'impact quadratique de la vitesse, convertissez les unités entre J, kJ, MJ et kWh, et explorez le mouvement dans le monde réel."
metaKeywords: "calculateur d'énergie cinétique, calculateur ec, calculateur d'énergie de mouvement, formule de l'énergie cinétique, théorème de l'énergie cinétique, simulateur d'impact de vitesse"
features:
  - "Cockpit Cinétique Interactif avec bascule entre le Mode Simple et le Mode Avancé"
  - "Résout l'Énergie Cinétique (EC = ½m·v²), la Masse (m = 2EC/v²) ou la Vitesse (v = √(2EC/m))"
  - "🔄 Barre supérieure du Hub d'Énergie Mécanique pour basculer rapidement entre l'Énergie Cinétique, Potentielle, le Travail, la Puissance et la Quantité de Mouvement"
  - "🎬 Simulateur d'Impact de Vitesse affichant une courbe quadratique interactive (EC ∝ v²)"
  - "📊 Panneau de Répartition de l'Influence Énergétique montrant les contributions de la masse par rapport au carré de la vitesse"
  - "⚡ Échelle de Comparaison d'Énergie comparant des balles de baseball, des boules de bowling, des athlètes en sprint, des voitures, des trains à grande vitesse et des fusées spatiales"
  - "🌍 Contexte du Mode Planète affichant le poids gravitationnel par rapport à l'énergie cinétique sur Terre, la Lune, Mars et Jupiter"
  - "Jauge d'Énergie à Arc Radial Logarithmique catégorisant les niveaux d'énergie"
  - "Générateur de Quiz de Physique Pratique avec des problèmes d'énergie aléatoires et des dérivations mathématiques étape par étape"
useCases:
  - "Étudiants et professeurs de physique dérivant l'énergie cinétique, le théorème de l'énergie cinétique et la conservation de l'énergie mécanique"
  - "Ingénieurs en sécurité automobile analysant les distances de freinage (d ∝ v²)"
  - "Ingénieurs en balistique et en aérospatiale calculant l'énergie d'impact des projectiles et la dissipation thermique de rentrée"
  - "Biomécaniciens du sport évaluant le transfert d'énergie cinétique dans les swings de golf, les lancers de baseball et le sprint"
howToSteps:
  - "Sélectionnez votre mode de calcul cible : Énergie Cinétique (EC), Masse (m) ou Vitesse (v)."
  - "Entrez vos valeurs connues dans les champs de saisie ou ajustez les curseurs de plage interactifs."
  - "Choisissez votre système d'unités préféré (par ex. Joules, Kilojoules, Mégajoules, Wattheures, Kilogrammes, m/s, km/h)."
  - "Lisez vos résultats calculés instantanément affichés dans la carte de résumé et inspectez la jauge d'énergie à arc radial."
  - "Basculez en Mode Avancé pour explorer le Simulateur d'Impact de Vitesse, le Panneau de Répartition de l'Énergie et le Mode Planète."
  - "Exportez votre résumé de calcul via une impression PDF, copiez le texte formaté ou partagez un lien de paramètre personnalisé."
faqs:
  - question: "Qu'est-ce que l'énergie cinétique en physique ?"
    answer: "L'énergie cinétique est la forme scalaire de l'énergie mécanique qu'un objet possède en raison de son mouvement, définie par EC = ½ · m · v²."
  - question: "Quelle est l'unité SI de l'énergie cinétique ?"
    answer: "L'unité SI de l'énergie cinétique est le Joule (J), défini comme 1 kg·m²/s² ou 1 Newton-mètre (N·m)."
  - question: "Quelle est la formule de l'énergie cinétique ?"
    answer: "La formule fondamentale de l'énergie cinétique de translation est EC = ½ · m · v², où m est la masse et v est la vitesse."
  - question: "L'énergie cinétique est-elle scalaire ou vectorielle ?"
    answer: "L'énergie cinétique est une grandeur scalaire, ce qui signifie qu'elle n'a qu'une amplitude et qu'elle est toujours positive (ou nulle)."
  - question: "Pourquoi l'énergie cinétique dépend-elle de la vitesse au carré (v²) ?"
    answer: "Le travail effectué pour accélérer un objet implique la force multipliée par le déplacement (W = F · d). Étant donné que le déplacement sous accélération évolue avec v², l'énergie cinétique évolue de manière quadratique avec la vitesse."
  - question: "Comment calculez-vous la masse à partir de l'énergie cinétique et de la vitesse ?"
    answer: "La masse est calculée en utilisant la formule m = 2 · EC / v²."
  - question: "Comment calculez-vous la vitesse à partir de l'énergie cinétique et de la masse ?"
    answer: "La vitesse est calculée en utilisant la formule v = √(2 · EC / m)."
  - question: "Qu'arrive-t-il à l'énergie cinétique si la vitesse est doublée ?"
    answer: "Parce que l'énergie cinétique dépend de v², doubler la vitesse quadruple (4x) l'énergie cinétique."
  - question: "Qu'arrive-t-il à l'énergie cinétique si la vitesse est triplée ?"
    answer: "Tripler la vitesse augmente l'énergie cinétique de neuf fois (9x)."
  - question: "Qu'arrive-t-il à l'énergie cinétique si la masse est doublée ?"
    answer: "Parce que l'énergie cinétique dépend linéairement de la masse, doubler la masse double (2x) l'énergie cinétique."
  - question: "Qu'est-ce que le Théorème de l'Énergie Cinétique ?"
    answer: "Le Théorème de l'Énergie Cinétique stipule que le travail net effectué sur un objet est égal à sa variation d'énergie cinétique : W_net = ΔEC = EC_final - EC_initial."
  - question: "Comment l'énergie cinétique est-elle liée à la distance de freinage des voitures ?"
    answer: "Le travail de freinage (W = F_frottement · d) absorbe l'énergie cinétique initiale (EC = ½mv²). Par conséquent, doubler la vitesse du véhicule quadruple la distance d'arrêt requise !"
  - question: "Quelle est la différence entre l'énergie cinétique et la quantité de mouvement ?"
    answer: "La quantité de mouvement (p = mv) est un vecteur proportionnel à la vitesse, tandis que l'énergie cinétique (EC = ½mv²) est un scalaire proportionnel à la vitesse au carré."
  - question: "Comment convertissez-vous l'Énergie Cinétique en Quantité de Mouvement ?"
    answer: "La quantité de mouvement est liée à l'énergie cinétique par p = √(2 · m · EC), ou EC = p² / (2m)."
  - question: "Quelle est la différence entre l'énergie cinétique et l'énergie potentielle ?"
    answer: "L'énergie cinétique est l'énergie du mouvement, tandis que l'énergie potentielle est l'énergie stockée en raison de la position ou de l'état (par ex. EP gravitationnelle = m·g·h)."
  - question: "Qu'est-ce que l'énergie mécanique ?"
    answer: "L'énergie mécanique est la somme totale de l'énergie cinétique et de l'énergie potentielle dans un système physique : E_méc = EC + EP."
  - question: "Quelle est la Loi de Conservation de l'Énergie Mécanique ?"
    answer: "En l'absence de forces non conservatives (comme le frottement ou la traînée), l'énergie mécanique totale reste constante : EC_initial + EP_initial = EC_final + EP_final."
  - question: "Qu'est-ce que l'énergie cinétique de rotation ?"
    answer: "L'énergie cinétique de rotation est l'énergie possédée par un corps en rotation, calculée par EC_rot = ½ · I · ω², où I est le moment d'inertie et ω est la vitesse angulaire."
  - question: "Quelle est l'énergie cinétique totale d'une roue qui roule ?"
    answer: "Une roue qui roule possède à la fois une énergie cinétique de translation et de rotation : EC_total = ½m·v² + ½I·ω²."
  - question: "Combien de Joules y a-t-il dans 1 Kilojoule (kJ) ?"
    answer: "1 Kilojoule (kJ) équivaut à 1 000 Joules."
  - question: "Combien de Joules y a-t-il dans 1 Mégajoule (MJ) ?"
    answer: "1 Mégajoule (MJ) équivaut à 1 000 000 de Joules."
  - question: "Combien de Joules y a-t-il dans 1 Wattheure (Wh) ?"
    answer: "1 Wattheure (Wh) équivaut à 3 600 Joules."
  - question: "Combien de Joules y a-t-il dans 1 Kilowattheure (kWh) ?"
    answer: "1 Kilowattheure (kWh) équivaut à 3 600 000 Joules (3,6 MJ)."
  - question: "Quelle quantité d'énergie cinétique possède une balle de baseball lancée ?"
    answer: "Une balle de baseball de 0,145 kg lancée à 40 m/s (90 mph) a une énergie cinétique d'environ 116 Joules."
  - question: "Quelle quantité d'énergie cinétique possède une boule de bowling qui roule ?"
    answer: "Une boule de bowling de 6 kg roulant à 8 m/s a une énergie cinétique de 192 Joules."
  - question: "Quelle quantité d'énergie cinétique possède un athlète en sprint ?"
    answer: "Un sprinteur de 75 kg courant à 10 m/s a une énergie cinétique de 3 750 Joules (3,75 kJ)."
  - question: "Quelle quantité d'énergie cinétique possède une voiture qui roule ?"
    answer: "Une berline de 1 500 kg roulant à 100 km/h (27,78 m/s) a une énergie cinétique de 578 773 Joules (~578,8 kJ)."
  - question: "Quelle quantité d'énergie cinétique possède un train à grande vitesse ?"
    answer: "Un train à grande vitesse de 400 000 kg voyageant à 300 km/h (83,33 m/s) a une énergie cinétique de 1,388 Milliard de Joules (1,39 GJ)."
  - question: "Quelle quantité d'énergie cinétique possède un avion de ligne commercial ?"
    answer: "Un avion de ligne de 180 000 kg volant à 900 km/h (250 m/s) a une énergie cinétique de 5,625 Milliards de Joules (5,63 GJ)."
  - question: "Qu'est-ce que l'énergie cinétique relativiste ?"
    answer: "À des vitesses proches de la vitesse de la lumière (c), l'énergie cinétique relativiste est calculée par EC = (γ - 1) · m · c², où γ = 1 / √(1 - v²/c²)."
  - question: "Qu'arrive-t-il à l'énergie cinétique lors d'une collision élastique ?"
    answer: "Dans une collision parfaitement élastique, l'énergie cinétique totale avant et après la collision est entièrement conservée."
  - question: "Qu'arrive-t-il à l'énergie cinétique lors d'une collision inélastique ?"
    answer: "Dans une collision inélastique, une partie de l'énergie cinétique est convertie en chaleur thermique, en son acoustique ou en déformation matérielle."
  - question: "L'énergie cinétique peut-elle être négative ?"
    answer: "Non. Parce que la masse est positive et que la vitesse est au carré (v² ≥ 0), l'énergie cinétique est strictement non négative (EC ≥ 0)."
  - question: "L'énergie cinétique peut-elle être nulle ?"
    answer: "Oui. Un objet au repos (v = 0) a une énergie cinétique nulle."
  - question: "L'énergie cinétique dépend-elle du référentiel ?"
    answer: "Oui ! Parce que la vitesse est relative au référentiel d'un observateur, l'énergie cinétique mesurée par un observateur dépend de leur vitesse relative."
  - question: "Qu'est-ce que l'énergie thermique en termes d'énergie cinétique ?"
    answer: "L'énergie thermique est l'énergie cinétique microscopique résultant de la vibration et de la translation aléatoires des atomes et des molécules individuels."
  - question: "Qu'est-ce que la température en physique ?"
    answer: "La température est une mesure de l'énergie cinétique de translation microscopique moyenne par molécule dans une substance."
  - question: "Comment une éolienne génère-t-elle de l'électricité à partir de l'énergie cinétique ?"
    answer: "Les éoliennes extraient l'énergie cinétique des masses d'air en mouvement (EC = ½ · ρ · A · v³) et la convertissent en énergie mécanique de rotation et en puissance électrique."
  - question: "Quelle est la formule de l'énergie cinétique du vent ?"
    answer: "La puissance de l'énergie cinétique du vent est P = ½ · ρ · A · v³, où ρ est la densité de l'air, A est la surface balayée par le rotor, et v est la vitesse du vent."
  - question: "Comment les barrages hydroélectriques produisent-ils de l'énergie à partir de l'énergie cinétique ?"
    answer: "L'eau stockée en hauteur libère de l'énergie potentielle gravitationnelle en énergie cinétique lorsqu'elle s'écoule dans les conduites forcées pour faire tourner les turbines hydroélectriques."
  - question: "Qu'est-ce que l'énergie d'impact en balistique ?"
    answer: "L'énergie d'impact est l'énergie cinétique délivrée par un projectile à une cible, déterminant la profondeur de pénétration et la perturbation des tissus."
  - question: "Qu'est-ce que la vitesse à la bouche ?"
    answer: "La vitesse à la bouche est la vitesse initiale d'un projectile lorsqu'il quitte le canon d'une arme à feu."
  - question: "Comment la masse affecte-t-elle l'énergie cinétique lorsque la vitesse est constante ?"
    answer: "L'énergie cinétique augmente de façon linéaire avec la masse : doubler la masse double l'énergie cinétique."
  - question: "Qu'est-ce que la dissipation par traînée aérodynamique de l'énergie cinétique ?"
    answer: "Les forces de traînée aérodynamique s'opposent aux objets en mouvement, convertissant l'énergie cinétique en chaleur ambiante et en mouvement d'air turbulent."
  - question: "Qu'est-ce que l'énergie cinétique à la vitesse terminale ?"
    answer: "À la vitesse terminale, la force de gravité vers le bas équilibre la traînée de l'air, ce qui fait que l'énergie cinétique d'un objet qui tombe reste constante."
  - question: "Comment fonctionne le freinage à récupération dans les véhicules électriques ?"
    answer: "Le freinage à récupération utilise les moteurs électriques comme générateurs lors de la décélération, récupérant l'énergie cinétique du véhicule et la convertissant en charge de batterie électrique."
  - question: "Qu'est-ce que le stockage d'énergie par volant d'inertie ?"
    answer: "Un volant d'inertie stocke l'énergie mécanique sous forme d'énergie cinétique de rotation (EC = ½Iω²) dans un lourd rotor en rotation soutenu par des paliers magnétiques à faible frottement."
  - question: "Qu'est-ce que l'énergie interne d'un gaz parfait ?"
    answer: "Pour un gaz parfait monoatomique, l'énergie thermique interne est égale à l'énergie cinétique de translation totale de ses atomes constitutifs : U = (3/2) · n · R · T."
  - question: "Qu'est-ce qu'un électronvolt (eV) ?"
    answer: "Un électronvolt est une unité microscopique d'énergie cinétique gagnée par un électron accélérant à travers un potentiel électrique de 1 Volt (1 eV = 1,602 × 10⁻¹⁹ J)."
  - question: "Comment les accélérateurs de particules augmentent-ils l'énergie cinétique ?"
    answer: "Les accélérateurs utilisent des champs électromagnétiques pour propulser des particules subatomiques chargées à des énergies cinétiques relativistes (échelle du TeV)."
  - question: "Qu'est-ce que l'énergie cinétique des rayons cosmiques ?"
    answer: "Les rayons cosmiques sont des noyaux atomiques à haute énergie voyageant dans l'espace à une vitesse proche de celle de la lumière avec des énergies cinétiques allant jusqu'à 10²⁰ eV."
  - question: "Qu'est-ce que l'énergie cinétique de vitesse de libération ?"
    answer: "L'énergie cinétique de vitesse de libération est l'énergie cinétique minimale requise pour qu'un objet échappe au puits gravitationnel d'une planète (EC_libération = G·M·m / r)."
  - question: "Comment les impacts de météorites provoquent-ils des cratères massifs ?"
    answer: "Les météorites se déplacent à des hypervitesses élevées (11 à 72 km/h). À l'impact, leur immense énergie cinétique se convertit instantanément en ondes de choc explosives, en chaleur et en roche vaporisée."
  - question: "Quel est le travail effectué par le frottement lors du glissement ?"
    answer: "Le travail de frottement réduit l'énergie cinétique selon W_frottement = -f_k · d = ΔEC."
  - question: "Comment les chaussures de sport absorbent-elles l'énergie cinétique d'impact ?"
    answer: "Les mousses de la semelle intermédiaire coussinée se déforment élastiquement lors de l'impact du pied, absorbant l'énergie d'impact de crête et en restituant une partie lors de la poussée des orteils."
  - question: "Quelle est l'erreur courante des étudiants dans les calculs de l'EC ?"
    answer: "Les erreurs courantes incluent l'oubli de mettre la vitesse au carré (en utilisant v au lieu de v²), l'omission du facteur ½, ou la confusion des unités de vitesse."
  - question: "La gravité affecte-t-elle l'amplitude de l'énergie cinétique de translation ?"
    answer: "Non. L'EC de translation dépend uniquement de la masse et de l'amplitude de la vitesse instantanée (EC = ½mv²), indépendamment de la force du champ gravitationnel."
  - question: "L'énergie cinétique est-elle conservée dans le mouvement quotidien du monde réel ?"
    answer: "Non. Le frottement, la résistance de l'air et le son mécanique convertissent l'énergie cinétique en énergie thermique dans des systèmes non isolés."
---
...
```mermaid
flowchart LR
    A[Énergie Cinétique Initiale<br/>EC = 578,8 kJ] --> C{Force de Freinage Appliquée<br/>F = 12 000 N}
    B[Énergie Cinétique Finale<br/>EC = 0 J] --> C
    
    C --> D[Calcul du Travail Requis<br/>W = ΔEC = 578,8 kJ]
    D --> E((Distance d'Arrêt<br/>d = W / F = 48,2 m))
...
```mermaid
xychart-beta
    title "Énergie Cinétique SUV vs Vitesse (Mise à l'échelle Quadratique)"
    x-axis "Vitesse (m/s)" [0, 10, 20, 30, 40]
    y-axis "Énergie Cinétique (Kilojoules)" 0 --> 1600
    line [0, 100, 400, 900, 1600]
```
...
```mermaid
xychart-beta
    title "Énergie Cinétique vs Masse (Vitesse Constante 25 m/s)"
    x-axis "Masse du Véhicule (kg)" [1000, 10000, 20000, 30000, 40000]
    y-axis "Énergie Cinétique (Mégajoules)" 0 --> 12.5
    line [0.31, 3.12, 6.25, 9.37, 12.5]
```
...
```mermaid
flowchart TD
    A[Sommet du Balancement<br/>Hauteur = 15m] -->|Chute| B(Point Médian<br/>Hauteur = 7,5m)
    B -->|Accélération| C[Bas du Balancement<br/>Hauteur = 0m]
    
    A -.-> D[EP : 73,5 kJ<br/>EC : 0 kJ<br/>Total : 73,5 kJ]
    B -.-> E[EP : 36,75 kJ<br/>EC : 36,75 kJ<br/>Total : 73,5 kJ]
    C -.-> F[EP : 0 kJ<br/>EC : 73,5 kJ<br/>Total : 73,5 kJ]
