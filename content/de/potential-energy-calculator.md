---
title: "Potenzielle Energie Rechner | Gravitationsenergie (PE = mgh) Löser"
description: "Kostenloser Online-Rechner für potenzielle Energie. Lösen Sie sofort PE = mgh, erkunden Sie 10 Planeten-Gravitations-Voreinstellungen, simulieren Sie die Energieumwandlung im freien Fall und rechnen Sie Energieeinheiten (J, kJ, MJ, kWh) um."
metaTitle: "Potenzielle Energie Rechner | Gravitationsenergie (PE = mgh) Löser"
metaDescription: "Kostenloser Online-Rechner für potenzielle Energie. Lösen Sie sofort PE = mgh, erkunden Sie 10 Planeten-Gravitations-Voreinstellungen, simulieren Sie die Energieumwandlung im freien Fall und rechnen Sie Energieeinheiten (J, kJ, MJ, kWh) um."
metaKeywords: "potenzielle energie rechner, pe rechner, gravitationsenergie rechner, pe mgh rechner, potenzielle energie formel, mechanische energie hub"
features:
  - "Interaktives Potenzial-Cockpit mit Umschaltmöglichkeit zwischen einfachem und erweitertem Modus"
  - "Berechnet potenzielle Energie (PE = mgh), Masse (m = PE/gh), Höhe (h = PE/mg) oder Gravitation (g = PE/mh)"
  - "🔄 Mechanische-Energie-Hub in der oberen Leiste für den schnellen Wechsel zwischen potenzieller Energie, kinetischer Energie, Arbeit, Leistung und Impuls"
  - "🪐 10 Planeten-Voreinstellungen des Sonnensystems (Erde, Mond, Mars, Merkur, Venus, Jupiter, Saturn, Uranus, Neptun, Pluto)"
  - "⚡ Freifall-Simulator für potenzielle ↔ kinetische Energie, der die PE-zu-KE-Umwandlung und die Aufprallendgeschwindigkeit anzeigt"
  - "🎯 Praxisnahe Voreinstellungen (Buch auf Tisch, Person auf Leiter, Gebäude, Berg, Turmdrehkran, Achterbahn, Wassertank, Staudamm, Rakete)"
  - "Logarithmische radiale Energieanzeige zur Kategorisierung von Energiestufen"
  - "Physik-Quiz-Generator zum Üben mit zufälligen Energieproblemen und schrittweisen mathematischen Herleitungen"
useCases:
  - "Physikschüler und -lehrer zur Herleitung von potenzieller Gravitationsenergie, der Erhaltung der mechanischen Energie und des freien Falls"
  - "Bau- und Maschinenbauingenieure zur Berechnung der Tragfähigkeit von Kränen, Gerüsten und erhöhten Wassertürmen"
  - "Wasserkraftingenieure zur Bestimmung der gespeicherten Wasserenergie hinter Staudämmen (PE = mgh)"
  - "Achterbahnarchitekten zur Berechnung von maximalen Hügelhöhen und theoretischen Höchstgeschwindigkeiten (v = √(2gh))"
howToSteps:
  - "Wählen Sie Ihren gewünschten Berechnungsmodus: Potenzielle Energie (PE), Masse (m), Höhe (h) oder Gravitation (g)."
  - "Geben Sie Ihre bekannten Werte in die Eingabefelder ein oder passen Sie die interaktiven Schieberegler an."
  - "Wählen Sie Ihr bevorzugtes Einheitensystem (z. B. Joule, Kilojoule, Megajoule, Kilogramm, Meter, Fuß, m/s²)."
  - "Wählen Sie optional eine Planeten-Voreinstellung (Erde, Mond, Mars, Jupiter), um verschiedene Gravitationsfelder zu testen."
  - "Aktivieren Sie den erweiterten Modus, um den Freifall-Energieumwandler-Simulator, den Planeten-Gravitations-Explorer und die Diagramme zu untersuchen."
...
faqs:
  - question: "Was ist potenzielle Energie in der Physik?"
    answer: "Potenzielle Energie ist gespeicherte Energie, die ein Objekt aufgrund seiner Position, Höhe oder internen Konfiguration innerhalb eines Kraftfeldes (z. B. Gravitationsfeld) besitzt."
  - question: "Wie lautet die Formel für die potenzielle Gravitationsenergie?"
    answer: "Die Formel für die potenzielle Gravitationsenergie in der Nähe der Erdoberfläche lautet PE = m · g · h, wobei m die Masse, g die Erdbeschleunigung und h die vertikale Höhe ist."
  - question: "Was ist die SI-Einheit der potenziellen Energie?"
    answer: "Die SI-Einheit der potenziellen Energie ist das Joule (J), definiert als 1 kg·m²/s² oder 1 Newtonmeter (N·m)."
  - question: "Ist potenzielle Energie skalar oder vektoriell?"
    answer: "Die potenzielle Energie ist eine skalare Größe, sie besitzt nur einen Betrag und keine Richtung."
  - question: "Was ist die Standard-Erdbeschleunigung?"
    answer: "Die Standard-Erdbeschleunigung (g) beträgt ungefähr 9,80665 m/s² (oft gerundet auf 9,81 m/s² oder 32,2 ft/s²)."
  - question: "Wie berechnet man die Masse aus potenzieller Energie, Höhe und Gravitation?"
    answer: "Die Masse wird mit der Formel m = PE / (g · h) berechnet."
  - question: "Wie berechnet man die Höhe aus potenzieller Energie, Masse und Gravitation?"
    answer: "Die Höhe wird mit der Formel h = PE / (m · g) berechnet."
  - question: "Wie berechnet man die Gravitation aus potenzieller Energie, Masse und Höhe?"
    answer: "Die Gravitation wird mit der Formel g = PE / (m · h) berechnet."
  - question: "Was passiert mit der potenziellen Energie, wenn die Höhe verdoppelt wird?"
    answer: "Da PE linear von der Höhe (h) abhängt, verdoppelt sich (2x) die potenzielle Energie, wenn die Höhe verdoppelt wird."
  - question: "Was passiert mit der potenziellen Energie, wenn die Masse verdoppelt wird?"
    answer: "Da PE linear von der Masse (m) abhängt, verdoppelt sich (2x) die potenzielle Energie, wenn die Masse verdoppelt wird."
  - question: "Was besagt der Energieerhaltungssatz der Mechanik?"
    answer: "In einem isolierten System ohne Reibung oder Luftwiderstand bleibt die gesamte mechanische Energie konstant: PE_anfang + KE_anfang = PE_ende + KE_ende."
  - question: "Wie wird im freien Fall potenzielle Energie in kinetische Energie umgewandelt?"
    answer: "Wenn ein Objekt aus der Höhe h fällt, nimmt seine potenzielle Energie ab, während seine kinetische Energie um denselben Betrag zunimmt (ΔKE = -ΔPE)."
  - question: "Was ist die Aufprallendgeschwindigkeit eines fallengelassenen Objekts?"
    answer: "Wenn man den Luftwiderstand ignoriert, beträgt die Aufprallendgeschwindigkeit am Boden (h = 0) v_aufprall = √(2 · g · h)."
  - question: "Wie hoch ist die Schwerkraft auf dem Mond?"
    answer: "Die Gravitationsbeschleunigung auf dem Mond beträgt ungefähr 1,62 m/s² (~16,5 % der Erdschwerkraft)."
  - question: "Wie hoch ist die Schwerkraft auf dem Mars?"
    answer: "Die Gravitationsbeschleunigung auf dem Mars beträgt ungefähr 3,71 m/s² (~38 % der Erdschwerkraft)."
  - question: "Wie hoch ist die Schwerkraft auf dem Jupiter?"
    answer: "Die Gravitationsbeschleunigung an den Wolkenobergrenzen des Jupiters beträgt ungefähr 24,79 m/s² (~253 % der Erdschwerkraft)."
  - question: "Was ist elastische potenzielle Energie?"
    answer: "Elastische potenzielle Energie ist Energie, die in einer verformten Feder oder einem elastischen Material gespeichert ist. Sie wird berechnet als PE_feder = ½ · k · x², wobei k die Federkonstante und x die Auslenkung ist."
  - question: "Was ist chemische potenzielle Energie?"
    answer: "Chemische potenzielle Energie ist Energie, die in chemischen Bindungen zwischen Atomen gespeichert ist und bei chemischen Reaktionen freigesetzt wird."
  - question: "Was ist elektrische potenzielle Energie?"
    answer: "Elektrische potenzielle Energie ist die Energie, die eine elektrische Ladung speichert, die sich in einem elektrostatischen Feld befindet (PE_elektrisch = q · V)."
  - question: "Was ist das Referenzniveau (Bezugspunkt) bei der potenziellen Energie?"
    answer: "Das Referenzniveau oder der Bezugspunkt ist die Basishöhe, bei der die potenzielle Energie willkürlich auf Null gesetzt wird (typischerweise auf Boden- oder Meeresspiegel)."
  - question: "Kann potenzielle Energie negativ sein?"
    answer: "Ja! Wenn sich ein Objekt unterhalb der gewählten Null-Referenzhöhe befindet (z. B. in einer Grube oder einem Graben), ist seine potenzielle Gravitationsenergie relativ zum Bodenniveau negativ."
  - question: "Wie viele Joule sind 1 Kilojoule (kJ)?"
    answer: "1 Kilojoule (kJ) entspricht 1.000 Joule."
  - question: "Wie viele Joule sind 1 Megajoule (MJ)?"
    answer: "1 Megajoule (MJ) entspricht 1.000.000 Joule."
  - question: "Wie viele Joule sind 1 Kilowattstunde (kWh)?"
    answer: "1 Kilowattstunde (kWh) entspricht 3.600.000 Joule (3,6 MJ)."
  - question: "Wie viel potenzielle Energie hat ein Buch auf einem 0,75 m hohen Schreibtisch?"
    answer: "Ein 1,5 kg schweres Buch auf einem 0,75 m hohen Schreibtisch hat eine potenzielle Energie von PE = 1,5 · 9,81 · 0,75 = 11,04 Joule."
  - question: "Wie viel potenzielle Energie hat eine Person auf einer 3 m hohen Leiter?"
    answer: "Eine 75 kg schwere Person auf einer 3 m hohen Leiter hat eine potenzielle Energie von PE = 75 · 9,81 · 3 = 2.207,25 Joule (~2,21 kJ)."
  - question: "Wie viel potenzielle Energie hat ein Wassertank auf dem Dach?"
    answer: "Ein 1.000 kg schwerer Wassertank auf einem 15 m hohen Dach hat eine potenzielle Energie von PE = 1000 · 9,81 · 15 = 147.150 Joule (~147,15 kJ)."
  - question: "Wie viel potenzielle Energie hat eine Achterbahn an einem 45 m hohen Gipfel?"
    answer: "Ein 800 kg schwerer Achterbahnzug an einem 45 m hohen Gipfel hat eine potenzielle Energie von PE = 800 · 9,81 · 45 = 353.160 Joule (~353,16 kJ)."
  - question: "Wie viel potenzielle Energie speichert Wasser hinter einem Wasserkraftwerk?"
    answer: "100.000 kg Wasser, das in 100 m Höhe hinter einem Wasserkraftwerk gestaut ist, enthält PE = 100.000 · 9,81 · 100 = 98.100.000 Joule (98,1 MJ)."
  - question: "Wie wandelt ein Staudamm potenzielle Energie in Elektrizität um?"
    answer: "Die potenzielle Energie des gespeicherten Wassers (PE = mgh) wird in kinetische Energie umgewandelt, wenn das Wasser durch Druckrohrleitungen fällt, um Wasserturbinen anzutreiben, die mit elektrischen Generatoren verbunden sind."
  - question: "Was ist ein Pumpspeicherkraftwerk?"
    answer: "Ein Pumpspeicherkraftwerk fungiert als riesige Wasserbatterie. Es pumpt in günstigen Schwachlastzeiten Wasser in ein höher gelegenes Reservoir und lässt es in Spitzenbedarfszeiten wieder ab, um Strom zu erzeugen."
  - question: "Wie sind Achterbahnen auf potenzielle Energie angewiesen?"
    answer: "Ein Achterbahnzug wird auf seinen höchsten Gipfel gezogen, um maximale potenzielle Energie aufzubauen. Die Schwerkraft wandelt diese PE dann in kinetische Energie um, um die Achterbahn durch Loopings und Kurven zu treiben."
  - question: "Was ist universelle potenzielle Gravitationsenergie?"
    answer: "Über astronomische Entfernungen ist die universelle potenzielle Gravitationsenergie PE = -G · M · m / r, wobei G die Gravitationskonstante, M und m die Massen und r der Abstand ist."
  - question: "Warum ist die universelle potenzielle Gravitationsenergie negativ?"
    answer: "Da die potenzielle Energie bei unendlichem Abstand (r = ∞) als Null definiert ist, erfordern anziehende Gravitationskräfte positive Arbeit, um Massen auseinanderzuziehen. Dies macht PE bei endlichen Entfernungen negativ."
  - question: "Was ist die Fluchtgeschwindigkeit im Hinblick auf potenzielle Energie?"
    answer: "Die Fluchtgeschwindigkeit ist die anfängliche Geschwindigkeit, die benötigt wird, damit die kinetische Energie gleich dem Betrag der potenziellen Gravitationsenergie ist: ½mv² = GMm/r → v_flucht = √(2GM/r)."
  - question: "Was ist die Oszillation der potenziellen Energie eines Pendels?"
    answer: "An seinen höchsten Schwingungspunkten hat ein Pendel maximale potenzielle Energie und null kinetische Energie. An seinem tiefsten Punkt ist PE am geringsten und KE maximal."
  - question: "Wie handhaben Turmdrehkräne die Sicherheit potenzieller Energie?"
    answer: "Turmdrehkräne verfügen über Gegengewichte, mechanische Bremsen und Notfall-Abstoppmechanismen, um eine katastrophale, unkontrollierte Freisetzung der potenziellen Energie schwerer Lasten zu verhindern."
  - question: "Was bedeutet 'Arbeit gegen die Schwerkraft leisten'?"
    answer: "Die Arbeit, die geleistet wird, um die Masse m um die Höhe h gegen die Schwerkraft anzuheben, entspricht W = F · h = (m · g) · h = ΔPE."
  - question: "Beeinflusst der zurückgelegte Weg die Änderung der potenziellen Gravitationsenergie?"
    answer: "Nein! Die Schwerkraft ist eine konservative Kraft, weshalb die Änderung der potenziellen Energie nur von den anfänglichen und endgültigen vertikalen Höhen abhängt, unabhängig davon, ob geschwungene oder zickzackförmige Wege genommen wurden."
  - question: "Was ist der Unterschied zwischen potenzieller und kinetischer Energie?"
    answer: "Potenzielle Energie ist gespeicherte Energie aufgrund von Position oder Höhe, während kinetische Energie die Energie der Bewegung ist."
  - question: "Was ist die gesamte mechanische Energie?"
    answer: "Die gesamte mechanische Energie ist E_gesamt = PE + KE."
  - question: "Beeinflusst der Luftwiderstand den Wert der potenziellen Energie?"
    answer: "Nein. Der Luftwiderstand beeinflusst die kinetische Energie und die thermische Dissipation während der Bewegung, aber die statische potenzielle Energie hängt ausschließlich von Höhe, Masse und der Stärke des lokalen Gravitationsfeldes ab."
  - question: "Wie wandelt Stabhochsprung Energie um?"
    answer: "Ein Stabhochspringer wandelt horizontale kinetische Energie (Anlauf) in elastische potenzielle Energie (Biegung des Stabes) um, die dann in potenzielle Gravitationsenergie umgewandelt wird (Überqueren der Latte)."
  - question: "Wie wandelt Bogenschießen potenzielle Energie um?"
    answer: "Das Spannen eines Bogens speichert elastische potenzielle Energie in den Wurfarmen. Das Loslassen der Sehne wandelt diese elastische PE in kinetische Energie des Pfeils um."
  - question: "Was ist die Höhe des Massenmittelpunkts bei der potenziellen Energie?"
    answer: "Für ausgedehnte physikalische Objekte (wie Gebäude oder Bäume) wird die potenzielle Energie anhand der Höhe des Massenmittelpunkts (h_cm) des Objekts berechnet."
  - question: "Wie verändert sich die Schwerkraft mit der Höhe über der Erde?"
    answer: "Die Schwerkraft nimmt mit der Höhe geringfügig ab, gemäß g(h) = g_oberfläche · (R_erde / (R_erde + h))². Auf Bodenhöhe wird g als konstant betrachtet."
  - question: "Was ist das Gravitationspotenzial?"
    answer: "Das Gravitationspotenzial (V) ist die potenzielle Energie pro Masseneinheit: V = PE / m = g · h."
  - question: "Wie funktioniert eine Ramme unter Nutzung der potenziellen Energie?"
    answer: "Eine Ramme hebt ein schweres Gewicht auf die Höhe h an (baut PE auf) und lässt es fallen, um PE in kinetische Aufprallenergie umzuwandeln, die Fundamentpfähle in den Boden treibt."
  - question: "Was ist der Ursprung der kinetischen Energie einer Lawine?"
    answer: "Schnee, der sich an steilen Berggipfeln angesammelt hat, besitzt immense potenzielle Gravitationsenergie, die sich bei einer Lawine schnell in zerstörerische kinetische Energie umwandelt."
  - question: "Was ist die potenzielle Energie eines Gezeitenkraftwerks (Tidal Barrage)?"
    answer: "Gezeitenkraftwerke stauen das Wasser bei Flut hinter einem Damm und erzeugen eine Fallhöhe (h), die bei Ebbe potenzielle Energie über Turbinen freisetzt."
  - question: "Was ist ein häufiger Fehler von Schülern bei der Berechnung von PE?"
    answer: "Häufige Fehler sind die Verwendung der Hangdistanz anstelle der vertikalen Höhe h, das Vergessen der lokalen Gravitationseinheiten oder das falsche Identifizieren der Nullreferenzhöhe."
  - question: "Hängt das Gravitationsfeld von der Masse des Objekts ab?"
    answer: "Nein. Die lokale Gravitationsbeschleunigung g hängt von der Masse und dem Radius des Planeten ab, unabhängig von der Masse des angehobenen Objekts."
  - question: "Wie verrichten Gewichtheber Arbeit, um potenzielle Energie aufzubauen?"
    answer: "Ein Gewichtheber, der eine Langhantel anhebt, verrichtet mechanische Arbeit W = mgh gegen die Schwerkraft und speichert diese Arbeit bei vollem Durchdrücken als potenzielle Energie der Hantel."
  - question: "Kann ein ruhendes Objekt potenzielle Energie haben?"
    answer: "Ja! Jedes Objekt, das in einer Höhe über dem Boden ruht, besitzt potenzielle Gravitationsenergie, selbst wenn es völlig regungslos ist."
---
...
```mermaid
flowchart LR
    A[Masse<br/>5.000 kg] --> D{Multiplizieren<br/>m * g * h}
    B[Gravitation<br/>9,81 m/s²] --> D
    C[Höhe<br/>320 m] --> D
    
    D --> E((Potenzielle Energie<br/>15,7 Megajoule))
...
```mermaid
xychart-beta
    title "Aufzug Potenzielle Energie vs. Höhe (Konstant 2500 kg Masse)"
    x-axis "Aufzugshöhe (Meter)" [0, 10, 20, 30, 40]
    y-axis "Potenzielle Energie (Kilojoule)" 0 --> 1000
...
```mermaid
flowchart TD
    A[Achterbahngipfel<br/>Höhe = 75m] -->|Furchteinflößender Abhang| B(Mitte des Abhangs<br/>Höhe = 37,5m)
    B -->|Maximale Beschleunigung| C[Ende des Abhangs<br/>Höhe = 0m]
    
    A -.-> D[PE: 5,88 MJ<br/>KE: 0 MJ<br/>Gesamt: 5,88 MJ]
    B -.-> E[PE: 2,94 MJ<br/>KE: 2,94 MJ<br/>Gesamt: 5,88 MJ]
    C -.-> F[PE: 0 MJ<br/>KE: 5,88 MJ<br/>Gesamt: 5,88 MJ]
