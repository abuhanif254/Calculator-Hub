---
title: "Leistungsfaktor-Rechner | Korrektur & Kondensatorgrößen-Löser"
description: "Kostenloser Online-Leistungsfaktor-Rechner. Berechnen Sie sofort Leistungsfaktor (PF), Wirkleistung (kW), Scheinleistung (kVA), Blindleistung (kVAR), Phasenwinkel, 1-phasigen und 3-phasigen Wechselstrom, Leistungsfaktorkorrektur und die Dimensionierung von Kondensatorbatterien."
metaTitle: "Leistungsfaktor-Rechner | Korrektur & Kondensatorgrößen-Löser"
metaDescription: "Kostenloser Online-Leistungsfaktor-Rechner. Berechnen Sie sofort Leistungsfaktor (PF), Wirkleistung (kW), Scheinleistung (kVA), Blindleistung (kVAR), Phasenwinkel, 1-phasigen und 3-phasigen Wechselstrom, Leistungsfaktorkorrektur und die Dimensionierung von Kondensatorbatterien."
metaKeywords: "leistungsfaktor rechner, pf rechner, leistungsfaktorkorrektur rechner, blindleistung rechner, scheinleistung rechner, kondensatorbatterie dimensionierung, 3 phasen leistungsfaktor rechner"
features:
  - "Interaktives Cockpit mit Umschalter zwischen Einfachem und Erweitertem Modus"
  - "5 Kategorien-Tabs: Basis AC PF-Löser, PF-Korrektur & Kondensatorgrößen, Vorher/Nachher-Vergleichs-Dashboard, Multi-Last-Vektor-Aggregation und Motor-/Transformator-Auslastung"
  - "📐 Interaktives dynamisches SVG-Leistungsdreieck, das Wirkleistung (P), Blindleistung (Q), Scheinleistung (S) und Phasenwinkel (φ) anzeigt"
  - "🔄 Interaktives Zeigerdiagramm zur Veranschaulichung von Spannung (V) gegenüber Strom (I) für voreilende, nacheilende oder ohmsche Ausrichtung"
  - "🏢 Multi-Last-Vektor-Aggregations-Builder (ΣP + jΣQ) zur Vermeidung falscher arithmetischer Mittelwertbildung"
  - "🔋 Dimensionierung von Kondensatorbatterien in Mikrofarad (μF) für 50Hz- und 60Hz-Systeme in Dreieck- (Δ) oder Stern- (Y) Topologien"
  - "📊 Vorher/Nachher-Korrekturanalyse, die die prozentuale Reduzierung des Leitungsstroms und die freigesetzte kVA-Transformatorkapazität anzeigt"
  - "Übungsquiz-Generator mit zufälligen Problemen der Leistungsfaktortechnik und schrittweisen mathematischen Herleitungen"
useCases:
  - "Elektroingenieure, die Kondensatorbatterien zur Leistungsfaktorkorrektur für industrielle Produktionsanlagen entwerfen"
  - "Facility Manager, die Strafzuschläge der Versorgungsunternehmen für Blindleistung reduzieren und Transformatorkapazitäten freisetzen wollen"
  - "Elektriker und Energietechniker, die 3-phasige 480V- und 400V-Kondensatorstufen dimensionieren"
  - "Ingenieurstudenten, die reale, reaktive und scheinbare Leistungsdreiecke sowie Phasenwinkel visualisieren möchten"
howToSteps:
  - "Wählen Sie Ihren AC-Systemtyp (1-phasig oder 3-phasig Außenleiter-zu-Außenleiter) und geben Sie die Systemspannung (V) ein."
  - "Geben Sie die Wirkleistung (P in kW) und den anfänglichen Leistungsfaktor (PF) ein."
  - "Geben Sie Ihren Ziel-Leistungsfaktor (z. B. 0.95 oder 0.98) und die Frequenz (50Hz oder 60Hz) an."
  - "Beobachten Sie das interaktive Leistungsdreieck, die erforderliche Kompensation (Qc in kVAR) und Mikrofarad (μF) pro Phase."
  - "Nutzen Sie das Vorher/Nachher-Dashboard, um die prozentuale Reduzierung des Leitungsstroms und die Freisetzung der Transformatorkapazität zu überprüfen."
  - "Klicken Sie auf 'Zusammenfassung kopieren' oder 'PDF drucken', um Ihren elektrotechnischen Analysebericht zu speichern."
faqs:
  - question: "Was ist der Leistungsfaktor (PF)?"
    answer: "Der Leistungsfaktor ist das Verhältnis der tatsächlich geleisteten Wirkleistung (kW) zur dem Stromkreis zugeführten Scheinleistung (kVA) (PF = P / S = cos φ). Er misst die Effizienz der AC-elektrischen Energie."
  - question: "Wie lautet die Formel für den Leistungsfaktor?"
    answer: "Leistungsfaktor PF = Wirkleistung P (kW) / Scheinleistung S (kVA). Alternativ: PF = cos(φ), wobei φ der Phasenverschiebungswinkel zwischen Wechselspannung und Strom ist."
  - question: "Was ist der Unterschied zwischen Wirkleistung, Blindleistung und Scheinleistung?"
    answer: "Die Wirkleistung P (kW) verrichtet tatsächliche Arbeit (Wärme, Licht, Bewegung). Die Blindleistung Q (kVAR) erhält die elektromagnetischen Felder in Motoren und Transformatoren aufrecht. Die Scheinleistung S (kVA) ist die gesamte Vektorkombination aus beiden (S = √(P² + Q²))."
  - question: "Was ist ein nacheilender Leistungsfaktor?"
    answer: "Ein nacheilender Leistungsfaktor tritt bei induktiven Lasten (Motoren, Transformatoren, Drosseln) auf, bei denen die Stromwellenform der Spannungswellenform hinterherhinkt (Phasenwinkel φ > 0)."
  - question: "Was ist ein voreilender Leistungsfaktor?"
    answer: "Ein voreilender Leistungsfaktor tritt bei kapazitiven Lasten (Kondensatorbatterien, langen Übertragungskabeln) auf, bei denen die Stromwellenform der Spannungswellenform vorausgeht (Phasenwinkel φ < 0)."
  - question: "Was ist ein Leistungsfaktor von Eins (unity)?"
    answer: "Ein Leistungsfaktor von Eins (PF = 1.0) tritt auf, wenn Spannungs- und Stromwellenformen perfekt in Phase sind (φ = 0°), was bedeutet, dass 100% der zugeführten Energie in reale Arbeit umgewandelt wird (0 kVAR Blindleistung)."
  - question: "Warum erheben Stromversorger Strafgebühren für den Leistungsfaktor?"
    answer: "Ein niedriger Leistungsfaktor zwingt die Versorgungsunternehmen, einen höheren Leitungsstrom und eine größere kVA-Transformatorkapazität bereitzustellen, um die gleiche Wirkleistung (kW) zu liefern, was zu höheren Übertragungsverlusten (I²R) in den Stromnetzen führt."
  - question: "Wie funktioniert die Leistungsfaktorkorrektur (PFC)?"
    answer: "Die Leistungsfaktorkorrektur fügt parallele Kondensatorbatterien hinzu, die eine voreilende Blindleistung (-kVAR) erzeugen und so die von induktiven Motoren bezogene nacheilende Blindleistung (+kVAR) neutralisieren."
  - question: "Wie lautet die Formel für die erforderliche kapazitive Kompensation (Qc)?"
    answer: "Qc = P × (tan φ1 - tan φ2), wobei P die Wirkleistung in kW ist, φ1 der anfängliche Phasenwinkel (arccos PF1) und φ2 der Ziel-Phasenwinkel (arccos PF2)."
  - question: "Wie berechnet man die Größe der Kondensatorbatterie in Mikrofarad (μF)?"
    answer: "Für Einphasensysteme: C = (Qc × 1000) / (2π f V²). Für 3-Phasen-Dreieck: C_delta = (Qc × 1000) / (3 × 2π f V_L²). Für 3-Phasen-Stern: C_wye = (Qc × 1000) / (2π f V_L²)."
  - question: "Wie berechnet man den Leitungsstrom in einem 3-phasigen AC-System?"
    answer: "Leitungsstrom I_L = (P × 1000) / (√3 × V_L × PF), wobei P = kW, V_L = Außenleiterspannung und PF = Leistungsfaktor."
  - question: "Wie berechnet man den Leitungsstrom in einem 1-phasigen AC-System?"
    answer: "Leitungsstrom I = (P × 1000) / (V × PF), wobei P = kW, V = Spannung und PF = Leistungsfaktor."
  - question: "Wie stark kann die Leistungsfaktorkorrektur den Leitungsstrom reduzieren?"
    answer: "Eine Verbesserung des PF von 0.75 auf 0.95 reduziert den Leitungsstrom um etwa 21% und verringert die Erwärmungsverluste der Kabel (I²R) um fast 37%."
  - question: "Warum kann man die Leistungsfaktoren bei der Kombination mehrerer Lasten nicht einfach mitteln?"
    answer: "Der Leistungsfaktor ist ein nichtlineares trigonometrisches Verhältnis (cos φ). Mehrere Lasten müssen aggregiert werden, indem die gesamte Wirkleistung (ΣP) und die gesamte Blindleistung (ΣQ) summiert und dann PF_total = ΣP / √( (ΣP)² + (ΣQ)² ) berechnet wird."
  - question: "Was ist das Leistungsdreieck?"
    answer: "Das Leistungsdreieck ist ein rechtwinkliges Dreieck, das die Vektorbeziehung zwischen Wirkleistung P (horizontale Basis), Blindleistung Q (vertikale Senkrechte) und Scheinleistung S (Hypotenuse) darstellt."
  - question: "Was ist der Unterschied zwischen dem Verschiebungsfaktor und dem wahren Leistungsfaktor?"
    answer: "Der Verschiebungsfaktor (Displacement PF) basiert ausschließlich auf der grundlegenden 50Hz/60Hz-Phasenverschiebung (cos φ1). Der wahre Leistungsfaktor (True PF) berücksichtigt die gesamte harmonische Verzerrung (THD), die durch nichtlineare Elektronik verursacht wird (True PF = Displacement PF × Harmonic Factor)."
  - question: "Was bedeutet eine Warnung vor harmonischer Verzerrung bei Kondensatorbatterien?"
    answer: "Nichtlineare Lasten (Frequenzumrichter, Schaltnetzteile) erzeugen harmonische Ströme. Standard-Kondensatorbatterien können mit der Systeminduktivität bei harmonischen Frequenzen in Resonanz geraten, was zu einer Zerstörung durch Überspannung führen kann."
  - question: "Was ist eine verdrosselte Kondensatorbatterie (detuned capacitor bank)?"
    answer: "Verdrosselte Kondensatorbatterien schalten Reihendrosseln (Induktivitäten) mit Kondensatoren zusammen, um die Resonanzfrequenz unter die niedrigste Harmonische (z.B. 5. Harmonische 300Hz) zu verschieben und so eine harmonische Verstärkung zu verhindern."
  - question: "Welchen Ziel-Leistungsfaktor haben Industrieanlagen?"
    answer: "Industrieanlagen zielen in der Regel auf einen Leistungsfaktor zwischen 0.95 und 0.98 nacheilend ab, um Strafzuschläge des Versorgers zu vermeiden, ohne das Risiko einer Überkompensation (voreilender PF) einzugehen."
  - question: "Was passiert, wenn ein System auf einen voreilenden Leistungsfaktor überkompensiert wird?"
    answer: "Eine Überkompensation auf einen voreilenden PF (PF < 1.0 voreilend) kann zu Generator-Spannungsinstabilität, unerwünschtem Hochspannungsanstieg bei geringer Last und dem Auslösen von Schutzrelais führen."
  - question: "Wie setzt die Verbesserung des Leistungsfaktors Transformatorkapazität frei?"
    answer: "Die Transformatorkapazität wird in kVA angegeben (S = P / PF). Die Erhöhung des PF von 0.75 auf 0.95 bei einer 100 kW-Last reduziert den kVA-Bedarf von 133.3 kVA auf 105.3 kVA und setzt 28 kVA an Reservekapazität des Transformators frei."
  - question: "Was ist eine automatische Blindleistungskompensation (APFC)?"
    answer: "Eine APFC-Anlage nutzt eine Mikroprozessorsteuerung, um automatisch Stufen von Kondensatorbatterien als Reaktion auf wechselnde induktive Motorlasten zu schalten und so einen konstanten Ziel-PF aufrechtzuerhalten."
  - question: "Welchen Phasenwinkel hat ein Leistungsfaktor von 0.80?"
    answer: "φ = arccos(0.80) = 36.87 Grad (0.6435 Radian)."
  - question: "Welchen Leistungsfaktor haben rein ohmsche Lasten (Heizungen, Glühlampen)?"
    answer: "Rein ohmsche Lasten haben einen Leistungsfaktor von 1.0 (Leistungsfaktor Eins, 0 kVAR Blindleistung, Phasenwinkel 0°)."
  - question: "Wie hoch ist der typische Leistungsfaktor eines unkompensierten Induktionsmotors?"
    answer: "Ein unkompensierter 3-Phasen-Induktionsmotor arbeitet unter Volllast bei einem PF von 0.80 bis 0.88 und kann im Leerlauf oder bei geringer Last auf bis zu 0.20 bis 0.50 PF fallen."
  - question: "Wie hoch ist der Leistungsfaktor moderner Computer-Schaltnetzteile?"
    answer: "Moderne Computer-Netzteile mit aktiver Leistungsfaktorkorrektur (Active PFC) arbeiten mit einem Leistungsfaktor von 0.95 bis 0.99."
  - question: "Senkt eine Leistungsfaktorkorrektur die Stromrechnung in Privathaushalten?"
    answer: "In der Regel nicht. Stromzähler in Privathaushalten berechnen nur die Wirkenergie (kWh), nicht den kVA-Bedarf oder kVAR. PFC kommt Gewerbe- und Industrieanlagen zugute, die kVA/kVAR-Abrechnungstarifen unterliegen."
  - question: "Was ist kVARh (Kilovarstunde)?"
    answer: "kVARh misst die im Laufe der Zeit kumulierte verbrauchte Blindenergie, die von industriellen Stromzählern zur Berechnung der Leistungsfaktor-Strafgebühren verwendet wird."
  - question: "Welche Nennspannung sollten Kondensatoren für eine 3-phasige 480V-Kompensation haben?"
    answer: "Für 480V-Systeme werden Kondensatoren mit einer Nennspannung von 525V oder 600V empfohlen, um einen Sicherheitsspielraum gegen harmonische Überspannungsspitzen zu bieten."
  - question: "Wie ist die Beziehung zwischen kVA, kW und kVAR?"
    answer: "(kVA)² = (kW)² + (kVAR)². Daher ist kVA = √( kW² + kVAR² )."
---
...
```mermaid
flowchart LR
    A["Wirkleistung (kW)<br/>Horizontaler Arbeitsvektor"] --> B{"Vektorsumme<br/>Phasenwinkelversatz"}
    
    C["Blindleistung (kVAR)<br/>Vertikaler Magnetischer Vektor"] --> B
    
    B --> D["Scheinleistung (kVA)<br/>Gesamtbelastung des Netzes"]
...
```mermaid
xychart-beta
    title "Strafzuschlag des Versorgers vs. Leistungsfaktor"
    x-axis "Leistungsfaktor (PF)" [0.95, 0.90, 0.85, 0.80, 0.75, 0.70]
    y-axis "Strafzuschlag in Prozent" 0 --> 25
    bar [0, 0, 5, 10, 18, 25]
```
...
```mermaid
flowchart TD
    A["Basisdaten extrahieren<br/>P=100kW, PF=0.75"] --> B{"Kompensationsberechnungen<br/>ausführen"}
    
    B --> C["Anfangswinkel berechnen<br/>tan(41.4 Grad) = 0.88"]
    B --> D["Zielwinkel berechnen<br/>tan(18.2 Grad) = 0.33"]
    
    C --> E["Formel ausführen<br/>Qc = 100 x (0.88 - 0.33)"]
    D --> E
    
    E --> F["Ergebnis: 55 kVAR erforderlich"]
    F --> G["Endgültige Auswahl:<br/>60 kVAR Stufenbank installieren"]
...
```mermaid
gantt
    title AC-Wellenformverzögerung (Spannung vs. Strom nacheilend)
    dateFormat  YYYY-MM-DD
    axisFormat  %H:%M
    
    section Spannungswellenform
    Spannung kreuzt Null und erreicht Spitze :crit, 2026-01-01 00:00, 1h
    
    section Stromwellenform
    Strom wird durch Induktivität verzögert :active, 2026-01-01 01:00, 1h
    
    section Phasenwinkel
    Zeitlücke erzeugt den Phasenwinkel :done, 2026-01-01 02:00, 1h
```
