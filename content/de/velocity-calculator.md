---
title: "Geschwindigkeitsrechner | Simulator für Geschwindigkeit, Strecke & Zeit"
description: "Kostenloser Online-Geschwindigkeitsrechner. Lösen Sie sofort v = s/t Gleichungen, rechnen Sie Einheiten um, simulieren Sie Bewegungen auf interaktiven Zeitachsen und vergleichen Sie Fluchtgeschwindigkeiten."
metaTitle: "Geschwindigkeitsrechner | Simulator für Geschwindigkeit, Strecke & Zeit"
metaDescription: "Kostenloser Online-Geschwindigkeitsrechner. Lösen Sie sofort v = s/t Gleichungen, rechnen Sie Einheiten um, simulieren Sie Bewegungen auf interaktiven Zeitachsen und vergleichen Sie Fluchtgeschwindigkeiten."
metaKeywords: "geschwindigkeitsrechner, tempo rechner, strecke zeit rechner, durchschnittsgeschwindigkeit, physik rechner, kinematik löser, fluchtgeschwindigkeit rechner, geschwindigkeit umrechner"
features:
  - "Interaktives Berechnungs-Cockpit, das es den Nutzern ermöglicht, sofort zwischen der Berechnung von Geschwindigkeit, Strecke oder Zeit zu wechseln"
  - "Unterstützung für Einheitenumrechnungen zwischen metrischen und imperialen Systemen"
  - "Animierte Bewegungs-Zeitachse, die Reisegeschwindigkeiten von Objekten mit Zeitlupen-Wiedergabe simuliert"
  - "Live-Balken für logarithmischen Geschwindigkeitsvergleich, der berechnete Geschwindigkeiten mit Benchmarks wie Schall und Licht vergleicht"
  - "Vergleiche der planetaren Fluchtgeschwindigkeiten und des Endtempos im freien Fall für Erde, Mond, Mars und Jupiter"
  - "Übungs-Physik-Quiz-Generator mit zufälligen Fragen, Antwortüberprüfungen und Schritt-für-Schritt-Lösungen"
useCases:
  - "Physikschüler, die Hausaufgaben in der 1D-Kinematik und bei Bewegungsprofilen lösen"
  - "Ingenieure, die Transitdauern, Fahrzeugdurchsätze und Maschinengeschwindigkeiten abschätzen"
  - "Athleten und Trainer, die Laufgeschwindigkeiten und Tempo-Raten über Distanzen verfolgen"
  - "Hobbyisten, die Drohnenpfade, Modelleisenbahn-Zeitachsen oder Raketengeschwindigkeiten simulieren"
howToSteps:
  - "Wählen Sie Ihre Zielvariable zur Berechnung aus: Geschwindigkeit, Strecke oder Zeit."
  - "Geben Sie die beiden bekannten Werte in die entsprechenden Eingabefelder ein."
  - "Wählen Sie Ihre bevorzugten Einheiten (z. B. Kilometer, mph, Minuten) aus den Dropdown-Auswahlmenüs."
  - "Lesen Sie das Live-Ergebnis ab, das sofort in mehreren äquivalenten Umrechnungen angezeigt wird."
  - "Spielen Sie die animierte Bewegungssimulation ab, um das Geschwindigkeitsprofil zu visualisieren."
  - "Versuchen Sie, eine zufällige Übungsaufgabe zu lösen, oder sehen Sie sich die Vergleiche der Fluchtgeschwindigkeiten an."
faqs:
  - question: "Was ist die Geschwindigkeit (Velocity)?"
    answer: "Die Geschwindigkeit ist eine vektorielle Größe, die die Änderungsrate der Verschiebung eines Objekts im Laufe der Zeit misst und dabei sowohl das Tempo als auch die Richtung angibt."
  - question: "Was ist das Tempo (Speed)?"
    answer: "Das Tempo ist eine skalare Größe, die die Rate misst, mit der ein Objekt eine Strecke zurücklegt, unabhängig von der Richtung."
  - question: "Wie unterscheiden sich Tempo und Geschwindigkeit?"
    answer: "Das Tempo ist skalar (nur Betrag, z. B. 50 km/h), während die Geschwindigkeit ein Vektor ist (Betrag und Richtung, z. B. 50 km/h in Richtung Norden)."
  - question: "Was sind die Einheiten der Geschwindigkeit?"
    answer: "Die SI-Einheit der Geschwindigkeit ist Meter pro Sekunde (m/s). Andere gebräuchliche Einheiten sind Kilometer pro Stunde (km/h), Meilen pro Stunde (mph), Fuß pro Sekunde (ft/s) und Knoten."
  - question: "Wie wird die Geschwindigkeit berechnet?"
    answer: "Die Geschwindigkeit wird berechnet, indem man die Verschiebung (Änderung der Position) durch die verstrichene Zeit dividiert: v = s / t."
  - question: "Wie lautet die Formel für die Geschwindigkeit?"
    answer: "Die grundlegende Formel ist v = s / t, wobei v die Geschwindigkeit, s die Verschiebung (Strecke) und t die Zeit ist."
  - question: "Was ist die Durchschnittsgeschwindigkeit?"
    answer: "Die Durchschnittsgeschwindigkeit ist die gesamte Verschiebung geteilt durch die für die Fahrt benötigte Gesamtzeit."
  - question: "Was ist das Durchschnittstempo?"
    answer: "Das Durchschnittstempo ist die gesamte zurückgelegte Strecke geteilt durch die verstrichene Gesamtzeit."
  - question: "Kann die Durchschnittsgeschwindigkeit null sein, auch wenn das Tempo es nicht ist?"
    answer: "Ja. Wenn ein Objekt an seinen Ausgangspunkt zurückkehrt, ist seine Nettoverschiebung null, was seine Durchschnittsgeschwindigkeit zu null macht, selbst wenn es eine große Strecke mit hohem Tempo zurückgelegt hat."
  - question: "Was ist die Momentangeschwindigkeit?"
    answer: "Die Momentangeschwindigkeit ist die Geschwindigkeit eines Objekts zu einem bestimmten Zeitpunkt, mathematisch definiert als der Grenzwert der Durchschnittsgeschwindigkeit, wenn das Zeitintervall gegen null geht."
  - question: "Was ist das Momentantempo?"
    answer: "Das Momentantempo ist das Tempo eines Objekts zu einem einzigen Zeitpunkt, gleich dem Betrag der Momentangeschwindigkeit."
  - question: "Was ist eine konstante Geschwindigkeit?"
    answer: "Eine konstante Geschwindigkeit tritt auf, wenn sich ein Objekt mit konstantem Tempo in einer perfekt geraden Linie bewegt, was bedeutet, dass sich sein Betrag und seine Richtung nicht ändern."
  - question: "Was ist Beschleunigung?"
    answer: "Die Beschleunigung ist die Änderungsrate der Geschwindigkeit über die Zeit: a = (v_final - v_initial) / t."
  - question: "Wie wirkt sich die Beschleunigung auf die Geschwindigkeit aus?"
    answer: "Eine positive Beschleunigung erhöht die Geschwindigkeit, eine negative Beschleunigung (Verzögerung) verringert die Geschwindigkeit, und eine laterale Beschleunigung ändert die Richtung der Geschwindigkeit."
  - question: "Was ist die Steigung eines Weg-Zeit-Diagramms?"
    answer: "Die Steigung eines Weg-Zeit-Diagramms (s-t-Diagramm) repräsentiert die Geschwindigkeit des Objekts."
  - question: "Was ist die Fläche unter einem Geschwindigkeits-Zeit-Diagramm?"
    answer: "Die Fläche unter einem Geschwindigkeits-Zeit-Diagramm (v-t-Diagramm) repräsentiert die Verschiebung oder die gesamte vom Objekt zurückgelegte Strecke."
  - question: "Was bedeutet eine negative Geschwindigkeit?"
    answer: "Eine negative Geschwindigkeit zeigt an, dass sich das Objekt in die entgegengesetzte Richtung der festgelegten positiven Koordinatenachse bewegt."
  - question: "Wie rechnet man m/s in km/h um?"
    answer: "Um Meter pro Sekunde (m/s) in Kilometer pro Stunde (km/h) umzurechnen, multiplizieren Sie den Wert mit 3,6."
  - question: "Wie rechnet man mph in m/s um?"
    answer: "Um Meilen pro Stunde (mph) in Meter pro Sekunde (m/s) umzurechnen, multiplizieren Sie den Geschwindigkeitswert mit 0,44704."
  - question: "Was ist die Endgeschwindigkeit (Terminalgeschwindigkeit)?"
    answer: "Die Endgeschwindigkeit ist die maximale, konstante Geschwindigkeit, die ein fallendes Objekt erreicht, wenn die nach oben gerichtete Luftwiderstandskraft der nach unten gerichteten Schwerkraft entspricht."
  - question: "Was ist die Fluchtgeschwindigkeit?"
    answer: "Die Fluchtgeschwindigkeit ist die Mindestgeschwindigkeit, die ein Objekt benötigt, um dem Gravitationsfeld eines Himmelskörpers ohne weiteren Antrieb zu entkommen."
  - question: "Wie hoch ist die Fluchtgeschwindigkeit der Erde?"
    answer: "Die Fluchtgeschwindigkeit der Erde beträgt etwa 11,2 Kilometer pro Sekunde (km/s) oder etwa 25.000 mph."
  - question: "Wie hoch ist die Fluchtgeschwindigkeit des Mondes?"
    answer: "Die Fluchtgeschwindigkeit des Mondes beträgt etwa 2,4 Kilometer pro Sekunde (km/s)."
  - question: "Wie hoch ist die Fluchtgeschwindigkeit des Mars?"
    answer: "Die Fluchtgeschwindigkeit des Mars beträgt etwa 5,0 Kilometer pro Sekunde (km/s)."
  - question: "Wie hoch ist die Fluchtgeschwindigkeit des Jupiter?"
    answer: "Die Fluchtgeschwindigkeit des Jupiter beträgt etwa 59,5 Kilometer pro Sekunde (km/s)."
  - question: "Wie hoch ist die Lichtgeschwindigkeit?"
    answer: "Die Lichtgeschwindigkeit im Vakuum beträgt exakt 299.792.458 Meter pro Sekunde (ca. 300.000 km/s)."
  - question: "Kann irgendein physisches Objekt schneller als die Lichtgeschwindigkeit reisen?"
    answer: "Nein. Gemäß Einsteins spezieller Relativitätstheorie ist die Lichtgeschwindigkeit im Vakuum das absolute Tempolimit für alle Materie und Informationen im Universum."
  - question: "Was ist die Winkelgeschwindigkeit?"
    answer: "Die Winkelgeschwindigkeit ist die Rotationsrate um eine Achse, gemessen in Radiant pro Sekunde (rad/s)."
  - question: "Wie hängt die Lineargeschwindigkeit mit der Winkelgeschwindigkeit zusammen?"
    answer: "Die Lineargeschwindigkeit (v) ist mit der Winkelgeschwindigkeit (ω) über den Radius (r) der Kreisbahn verbunden: v = r · ω."
  - question: "Was ist die Relativgeschwindigkeit?"
    answer: "Die Relativgeschwindigkeit ist die Geschwindigkeit eines Objekts, beobachtet aus dem Bezugssystem eines anderen bewegten Beobachters oder Objekts."
  - question: "Wie berechnet man die Relativgeschwindigkeit?"
    answer: "Für zwei Objekte, die sich in dieselbe Richtung bewegen, ist die Relativgeschwindigkeit v_ab = v_a - v_b. Wenn sie sich in entgegengesetzte Richtungen bewegen, ist sie v_ab = v_a + v_b."
  - question: "Was ist die Schallgeschwindigkeit (Mach)?"
    answer: "Die Schallgeschwindigkeit in trockener Luft bei 20 °C (68 °F) beträgt etwa 343 Meter pro Sekunde (1.235 km/h oder 767 mph), bezeichnet als Mach 1."
  - question: "Wie beeinflusst die Temperatur die Schallgeschwindigkeit?"
    answer: "Die Schallgeschwindigkeit steigt mit zunehmender Lufttemperatur, weil wärmere Luftmoleküle schneller schwingen und Energie übertragen."
  - question: "Was ist eine Geschwindigkeitsanzeige?"
    answer: "Eine Geschwindigkeitsanzeige ist ein Instrument oder eine visuelle Dashboard-Anzeige, die das aktuelle Tempo und die Richtungsvektoren eines sich bewegenden Objekts anzeigt."
  - question: "Wie funktioniert ein Tachometer?"
    answer: "Ein Tachometer misst die Rotationsrate der Räder oder der Getriebeausgangswelle eines Fahrzeugs und wandelt sie um, um das Tempo in mph oder km/h anzuzeigen."
  - question: "Was ist Verschiebung (Displacement)?"
    answer: "Die Verschiebung ist die geradlinige Distanz und Richtung vom Ausgangspunkt eines Objekts zu seiner Endposition."
  - question: "Wie unterscheidet sich die Verschiebung von der Strecke?"
    answer: "Die Strecke ist die Gesamtlänge des zurückgelegten Weges, während die Verschiebung der geradlinige Abkürzungsvektor zwischen Start- und Endpunkt ist."
  - question: "Wie hoch ist die Geschwindigkeit eines Objekts im freien Fall?"
    answer: "Im Vakuum nimmt die Geschwindigkeit jede Sekunde um 9,81 m/s zu: v = g · t."
  - question: "Beeinflusst die Masse das Tempo eines fallenden Objekts im Vakuum?"
    answer: "Nein. Im Vakuum beschleunigt die Schwerkraft alle Massen mit exakt derselben Rate (9,81 m/s²), sodass sie unabhängig vom Gewicht mit demselben Tempo fallen."
  - question: "Was ist die Endgeschwindigkeit eines Menschen?"
    answer: "Für einen Menschen in der Bauch-zur-Erde-Position beträgt die Endgeschwindigkeit etwa 54 m/s (120 mph oder 200 km/h)."
  - question: "Was ist die durchschnittliche Gehgeschwindigkeit?"
    answer: "Die durchschnittliche Gehgeschwindigkeit eines Menschen beträgt etwa 1,4 Meter pro Sekunde (ca. 5 km/h oder 3,1 mph)."
  - question: "Was ist die durchschnittliche Laufgeschwindigkeit?"
    answer: "Das durchschnittliche Jogging-Tempo eines Menschen liegt bei etwa 3 bis 4 m/s, während Elite-Sprinter Spitzenwerte nahe 12 m/s erreichen können."
  - question: "Was ist die durchschnittliche Fahrradgeschwindigkeit?"
    answer: "Die durchschnittliche Fahrradgeschwindigkeit für Freizeitradler beträgt etwa 5,5 m/s (20 km/h oder 12 mph)."
  - question: "Wie schnell fliegt ein Verkehrsflugzeug?"
    answer: "Verkehrsflugzeuge fliegen mit einer Reisegeschwindigkeit von rund 250 m/s (900 km/h oder 560 mph)."
  - question: "Wie schnell fährt ein Hochgeschwindigkeitszug (Bullet Train)?"
    answer: "Hochgeschwindigkeitszüge verkehren mit Geschwindigkeiten zwischen 80 und 100 m/s (280 bis 360 km/h)."
  - question: "Was ist Geschwindigkeit im Sport?"
    answer: "Die Geschwindigkeit misst Wurfgeschwindigkeiten im Baseball, Aufschlaggeschwindigkeiten im Tennis und Schussgeschwindigkeiten im Hockey oder Fußball, und zeigt so die Leistung des Projektils."
  - question: "Wie wird die Geschwindigkeit in der F1 gemessen?"
    answer: "F1-Autos verfolgen die Geschwindigkeit mithilfe von Raddrehzahlsensoren, GPS-Satelliten-Tracking und Pitotrohren, die die relative Luftstromgeschwindigkeit messen."
  - question: "Was ist die Driftgeschwindigkeit?"
    answer: "Die Driftgeschwindigkeit ist die durchschnittliche Geschwindigkeit, mit der sich subatomare geladene Teilchen (wie Elektronen) durch einen Leiter bewegen, wenn ein elektrisches Feld angelegt wird."
  - question: "Was ist die Orbitalgeschwindigkeit?"
    answer: "Die Orbitalgeschwindigkeit ist die Geschwindigkeit, die erforderlich ist, damit ein Satellit eine stabile kreisförmige Umlaufbahn um einen Hauptkörper wie die Erde aufrechterhält."
  - question: "Wie hoch ist die Geschwindigkeit der Erde um die Sonne?"
    answer: "Die Erde umkreist die Sonne mit einer Durchschnittsgeschwindigkeit von etwa 29,78 Kilometern pro Sekunde (107.200 km/h)."
  - question: "Was ist Kinematik?"
    answer: "Die Kinematik ist der Zweig der klassischen Mechanik, der sich mit der Bewegung von Objekten befasst, ohne Bezug auf die Kräfte zu nehmen, die die Bewegung verursachen."
  - question: "Was sind die drei Bewegungsgleichungen?"
    answer: "Die Gleichungen lauten: v = u + at, s = ut + 0,5·at² und v² = u² + 2as, wobei u die Anfangsgeschwindigkeit, v die Endgeschwindigkeit, a die Beschleunigung, t die Zeit und s die Verschiebung ist."
  - question: "Wie beeinflusst der Luftwiderstand die Geschwindigkeit?"
    answer: "Der Luftwiderstand übt einen Widerstand entgegen der Geschwindigkeit aus, verlangsamt Objekte und begrenzt die Geschwindigkeit auf die Endgeschwindigkeit."
  - question: "Was ist der Unterschied zwischen Durchschnittstempo und Durchschnittsgeschwindigkeit?"
    answer: "Das Durchschnittstempo ist die Gesamtstrecke / Gesamtzeit (skalar). Die Durchschnittsgeschwindigkeit ist die Gesamtverschiebung / Gesamtzeit (vektoriell)."
  - question: "Kann die Geschwindigkeit ohne Zeit berechnet werden?"
    answer: "Ja, unter Verwendung der kinematischen Gleichung: v = sqrt(u² + 2as), gegeben Anfangsgeschwindigkeit, Beschleunigung und Verschiebung."
  - question: "Was ist die Anfangsgeschwindigkeit?"
    answer: "Die Anfangsgeschwindigkeit (u oder v_i) ist die Geschwindigkeit eines Objekts zu Beginn eines gegebenen Zeitintervalls."
  - question: "Was ist die Endgeschwindigkeit?"
    answer: "Die Endgeschwindigkeit (v oder v_f) ist die Geschwindigkeit eines Objekts am Ende eines gegebenen Zeitintervalls."
  - question: "Was ist ein Geschwindigkeits-Zeit-Diagramm?"
    answer: "Ein Geschwindigkeits-Zeit-Diagramm stellt die Geschwindigkeit auf der vertikalen Achse und die Zeit auf der horizontalen Achse dar. Die Beschleunigung ist die Steigung, und die Strecke ist die Fläche."
  - question: "Was sind häufige Umrechnungsfehler?"
    answer: "Häufige Fehler sind Division statt Multiplikation (z. B. die Umrechnung von km/h in m/s durch Multiplikation mit 3,6 statt Division) und die Verwechslung von Minuten mit Stunden."
  - question: "Ist die Geschwindigkeit ein Vektor oder Skalar?"
    answer: "Die Geschwindigkeit (Velocity) ist eine vektorielle Größe, da sie sowohl Betrag als auch Richtung hat."
  - question: "Ist Tempo ein Vektor oder Skalar?"
    answer: "Das Tempo (Speed) ist eine skalare Größe, da es nur den Betrag (wie schnell) ohne Richtung repräsentiert."
  - question: "Wie wirkt sich die Schwerkraft auf die horizontale Geschwindigkeit aus?"
    answer: "Die Schwerkraft beeinflusst die horizontale Geschwindigkeit nicht, da sie Objekte nur vertikal nach unten zieht."
---
...
```mermaid
xychart-beta
    title "Sarahs Pendelweg: Verschiebung vs. Zeit"
    x-axis "Zeit (Stunden)" [0, 0.25, 0.5, 0.75, 1.0, 1.25, 1.5]
    y-axis "Verschiebung von zu Hause (km)" 0 --> 35
    line [0, 15, 30, 30, 22.5, 15, 0]
```
...
```mermaid
flowchart LR
    A[Meter pro Sekunde <br/> m/s] -->|Multiplizieren mit 3,6| B(Kilometer pro Stunde <br/> km/h)
    A -->|Multiplizieren mit 2,237| C(Meilen pro Stunde <br/> mph)
    B -->|Dividieren durch 1,609| C
    C -->|Multiplizieren mit 1,609| B
    B -->|Dividieren durch 3,6| A
    C -->|Multiplizieren mit 0,447| A
...
```mermaid
xychart-beta
    title "Autobahnjagd: Position vs. Zeit"
    x-axis "Zeit (Stunden)" [0, 0.1, 0.2, 0.333, 0.4]
    y-axis "Position auf der Autobahn (km)" 0 --> 70
    line [10, 22, 34, 50, 58] 
    line [0, 15, 30, 50, 60]
```
...
```mermaid
xychart-beta
    title "Fluchtgeschwindigkeiten von Himmelskörpern im Sonnensystem (km/s)"
    x-axis "Himmelskörper" ["Mond", "Merkur", "Mars", "Erde", "Neptun", "Jupiter"]
    y-axis "Geschwindigkeit (km/s)" 0 --> 65
    bar [2.38, 4.25, 5.03, 11.19, 23.5, 59.5]
```
