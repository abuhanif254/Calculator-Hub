...
const registry: Record<string, ComponentType<CalcComponentProps>> = {
  ...
  'median-calculator': dynamic(() => import('@/app/components/MedianCalculator/MedianCalculator').then(m => ({ default: m.default as ComponentType<CalcComponentProps> }))),
  'mode-calculator': dynamic(() => import('@/app/components/ModeCalculator/ModeCalculator').then(m => ({ default: m.default as ComponentType<CalcComponentProps> }))),
  'z-score-calculator': dynamic(() => import('@/app/components/ZScoreCalculatorView').then(m => ({ default: m.ZScoreCalculatorView as ComponentType<CalcComponentProps> }))),
  't-test-calculator': dynamic(() => import('@/app/components/t-test/TTestCalculatorView').then(m => ({ default: m.TTestCalculatorView as ComponentType<CalcComponentProps> }))),
