...
export default function HistogramChart({ data, mean }: HistogramChartProps) {
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <ReferenceLine 
            ...
            strokeDasharray="3 3"
            strokeWidth={2}
            label={{ value: 'Mean', position: 'top', fill: '#ef4444', fontSize: 12, fontWeight: 'bold' }} 
          />
          <Bar 
            dataKey="count" 
            name="Frequency" 
