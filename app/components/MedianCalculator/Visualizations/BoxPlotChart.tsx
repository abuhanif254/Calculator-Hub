  ...
  return (
    <div className="w-full py-10 px-4">
      <div className="relative h-32 w-full max-w-4xl mx-auto flex items-center">
        ...
        {/* The Box (IQR) */}
        <div 
          className="absolute h-12 bg-indigo-100 dark:bg-indigo-900/50 border-2 border-indigo-500 rounded-sm transition-all duration-700 group hover:bg-indigo-200 dark:hover:bg-indigo-800/50 cursor-pointer shadow-sm"
        ...
        <div 
          className="absolute h-12 w-1.5 bg-red-500 transition-all duration-700 transform -translate-x-1/2 z-10"
          style={{ left: `${pMedian}%` }}
        ></div>
      ...
      <div className="flex flex-wrap justify-center mt-6 gap-6 text-xs text-gray-500 dark:text-gray-400">
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 bg-indigo-100 border border-indigo-500"></div> Interquartile Range (IQR)
        </div>
        <div className="flex items-center gap-2">
          <div className="w-1.5 h-3 bg-red-500"></div> Median
        </div>
        <div className="flex items-center gap-2">
