    ...
    <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6">
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          posts.map(post => (
            <Link key={post.id} href={`/community/${post.slug}`} className="block bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 hover:shadow-md transition-shadow group">
