...
const roles = [
  {
    ...
    members: 1,
    desc: "Full platform access including user management and danger-zone operations.",
  },
  {
    ...
    members: 1,
    desc: "Can view all data, generate compliance reports, and manage masking rules.",
  },
  {
    name: "DBA",
    ...
    members: 1,
    desc: "Can manage database connections, run scanners, and execute anonymization jobs.",
  },
  {
    name: "Developer",
    ...
    members: 2,
    desc: "Can view connections, run exports, and access anonymized datasets.",
  },
  {
    name: "Read-Only",
    ...
    members: 1,
    desc: "View-only access to the dashboard, reports, and job history.",
  },
];
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Configure role-based access control for your team"
      />
