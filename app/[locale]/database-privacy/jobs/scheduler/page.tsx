...
const initSchedules = [
  {
    id: "s1",
    name: "Nightly QA Refresh",
    db: "qa-postgres-cluster",
    profile: "GDPR Pro Pack",
    schedule: "Daily at 02:00 UTC",
    next: "Tonight 02:00",
    last: "Yesterday 02:00",
    status: "Active",
  },
  {
    id: "s2",
    name: "Weekly Staging Mask",
    db: "staging-mysql-main",
    profile: "HIPAA Complete",
    schedule: "Weekly · Mon 00:00 UTC",
    next: "Mon Jul 22",
    last: "Mon Jul 15",
    status: "Active",
  },
...
export default function SchedulerPage() {
  ...
  const add = () => {
    ...
    setSchedules((p) => [
      ...p,
      {
        ...
        schedule: `${form.freq} at ${form.time} UTC`,
        next: "Calculating...",
        last: "Never",
        status: "Active",
      },
    ...
    toast.success(
      "Schedule Created",
      `"${form.name}" will run ${form.freq.toLowerCase()}.`,
    );
    setAdding(false);
  };
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Job Scheduler"
        subtitle="Automate masking runs on a recurring schedule"
      >
        <button
            ...
            {[
              {
                ...
                key: "name",
                type: "text",
                placeholder: "e.g. Nightly Prod Refresh",
              },
              {
