...
export const alt = 'Nexus Calculator Educational Guide';
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function Image({
  ...
  const guide = baseGuide ? getLocalizedGuide(baseGuide, locale) : null;

  const rawTitle = guide?.title || 'Educational Guide & Tutorial';
  const rawCategory = (guide?.category ? `${guide.category} Guide` : 'Tutorial').toUpperCase();
  const rawDesc = guide?.description || 'Learn mathematical formulas, practical steps, and calculation methods on Nexus Calculator.';
  const readingTime = guide?.readingTime || 5;
    ...
    (
      ...
      >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <span style={{ fontSize: '13px', color: '#94a3b8', letterSpacing: '1px' }}>
                FORMULAS • TUTORIALS • METHODOLOGIES
              </span>
            </div>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '1000px' }}>
          ...
          >
            <span>{readingTime} MIN READ • COMPREHENSIVE GUIDE</span>
          </div>
          <h1
            style={{
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '28px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <span style={{ color: '#cbd5e1', fontSize: '15px', fontWeight: 600 }}>Step-by-Step Tutorial</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#518231', display: 'flex' }} />
              <span style={{ color: '#cbd5e1', fontSize: '15px', fontWeight: 600 }}>Mathematical Proofs</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#518231', display: 'flex' }} />
              <span style={{ color: '#cbd5e1', fontSize: '15px', fontWeight: 600 }}>Interactive Engine</span>
            </div>
          </div>
